...
<body id="cuerpoPagina">
    ...
    <div class="zona_impresion">
        <table border="0" align="center" width="915px" style="font-size:15pt;border-right: #000 2px solid;color:black;border-left: #000 2px solid;">
            <?php
            $total = 0;
            ...
            <thead>
                ...
                <tr>
                    <td style="text-align: center; font-size: 20px;     font-family:  Arial, Helvetica, sans-serif;  " class="text-center"><b>Kude de Factura Electronica </b></td>
                </tr>
        ...
        <table border="0" align="center" width="915px" style="font-size:15pt;border-right: #000 2px solid;color:black;border-left: #000 2px solid;">
            ...
            <thead>
                ...
                <tr style="border-right: #000 2px solid;">
        ...
        <table border="0" align="center" width="915px" style="font-size:15pt;margin-top: -26px;border-right: #000 2px solid;color:black;border-left: #000 2px solid;">
            <thead>
                <tr>
