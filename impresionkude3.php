...
<body id="cuerpoPagina" style="margin-left: 60px;">
    <?php
    ...
    ?>
    <div>
        <table width="100%" class="borde-l borde-r borde-b borde-t" style="font-size:15pt;">
            <?php
            $total = 0;
            ...
            <thead>
                ...
                <tr>
                    <td style="text-align: center; font-size: 30px;     font-family:  Arial, Helvetica, sans-serif;  " class="text-center"><b>Kude de Factura Electronica </b></td>
                </tr>
  ...
  " class="borde-t">
            ...
            <table style="font-size:15pt;     width: 5%; " class="borde-r">
                <?php
                $total = 0;
                $ventas = VentaData::getById($_GET["id_venta"]);
                $procesos = OperationData::getAllProductsBySellIddd($_GET["id_venta"]);
                ...
                <thead>
                    <div style="margin:5px 0px ;">
                        <p>
                            ...
                            <b style="font-size: 30px; "> <?php echo $ventas->verSocursal()->razon_social ?></b>

                        </p>
                        <p>

                            <b style="font-size: 20px; ">Sociedad de responsabilidad limitada</b>

                        </p>
                        <p><?php echo $ventas->verSocursal()->actividad ?></p>

                        <p>
                            Boqueron C/E Ayola Ciudad del Este - Paraguay
                        </p>
                        <p>
                            Tel: <?= $ventas->verSocursal()->telefono ?>
                        </p>
                        <p>
            ...
            <table style="font-size:15pt; margin-left:60px">
                <?php
                $total = 0;
                $ventas = VentaData::getById($_GET["id_venta"]);
                $procesos = OperationData::getAllProductsBySellIddd($_GET["id_venta"]);
    ...
    <table align="center" class="borde-t " width="100%" style="font-size:15pt; padding: 15px 0px">
        <thead>
            ...
            <tr>
                ...
                <td>
                    Fecha y hora de emision:<?php $ventas->fecha_envio;
    ...
    <table border="1" width="100%" style="font-size:15pt;margin-top: -26px;  border-collapse: collapse;" class="table">
        ...
        <tbody>
            <tr>
                ...
                <p>
                    <td align="center" style=" font-size: 14px; font-family:  Arial, Helvetica, sans-serif;">Unidad</td>
                </p>
                <p>
