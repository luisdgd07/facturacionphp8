    ...
    <div class="zona_impresion" style="margin-top: 125px;">
        <table border="0" align="center" width="915px" style="font-size:15pt;">
            ...
            <div style="font-size:11pt; margin-left:198px">
                ...
                <b>
                    <p style="font-size:12pt; white-space: nowrap;padding-bottom: 0px;margin-top: 10px; margin-left:25px">
                        <?=
        ...
        <table border="0" align="center" width="912px" style="font-size:14pt;margin-top: 6px; margin-left:81px">
            <thead>
                <tr>
                    ...
                    <p>
                        <td style="width:12%;font-family:  Arial, Helvetica, sans-serif;"><strong>
                            </strong></td>
                    </p>
                    <p>
                        <td style="width:11%;font-family:  Arial, Helvetica, sans-serif;"><strong>
                            </strong></td>
                    </p>
                    <p>
                        <td style="width:10%;font-family:  Arial, Helvetica, sans-serif;"><strong>
                            ...
                            <p>
                                <td style=" font-size: 14px;font-family:  Arial, Helvetica, sans-serif;"><?php if ($ventas->VerTipoModena()->simbolo == "₲") {
                                                                                                                if ($ventas1->impuesto == 30) {
                                                                                                                    echo number_format($ventas->exenta, 2, ',', '.') . " Gs";
                                                                                                                } else {
        ...
        <table border="0" class="marrrr<?php echo $lines ?>" align="center" width="865px" style="font-size:15pt; margin-top: <?php
                                                                                                                                if ($lines2 == 0 && $lines == 0) {
                                                                                                                                    echo (306);
                                                                                                                                } else if ($lines == 1) {
                                                                                                                                    echo 285;
        ...
        <table border="0" align="center" width="915px" style="font-size:15pt;">
            ...
            <div style="font-size:11pt; margin-left:198px">
                ...
                <b>
                    <p style="font-size:12pt; white-space: nowrap;padding-bottom: 1px;margin-top: 10px; margin-left:25px">
                        <?=
                        $ventas->getCliente()->direccion ?>
