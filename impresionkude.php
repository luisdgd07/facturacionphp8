  ...
  " ">
    ...
    <table border="1" width="100%" style="font-size:15pt;margin-top: -26px;  border-collapse: collapse;" class="table">
        ...
        <tbody>
            <tr>
                <p>
                    <td align="center" style=" width:10%;font-size: 8px; font-family:  Arial, Helvetica, sans-serif;"><?= $ventas1->codigo ?></td>
                </p>
                <p>
                    <td align="center" style="width:22%; font-size: 8px; font-family:  Arial, Helvetica, sans-serif;"><?= $ventas1->nombre ?></td>
                </p>
                <p>
                    <td align="center" style=" font-size: 8px; font-family:  Arial, Helvetica, sans-serif;">CAJAS</td>
                </p>
                <p>
                    <td align="center" style=" font-size: 8px; font-family:  Arial, Helvetica, sans-serif;"> <?= $proceso->q ?></td>
                </p>
                <p>
                    <td align="center" style=" font-size: 8px;font-family:  Arial, Helvetica, sans-serif;"><?= number_format(($proceso->precio), 2, ',', '.') ?></td>
                </p>
                <p>
                    <td align="center" style="font-size: 8px;font-family:  Arial, Helvetica, sans-serif;">0,00</td>
                </p>
                <p>
                    <td align="center" style="font-size: 8px;font-family:  Arial, Helvetica, sans-serif;"><?php
                ...
                <p>
                    <td align="center" align="right" style="width:12%; font-size: 8px;font-family:  Arial, Helvetica, sans-serif;"><?php
    ...
    <table width="100%" style="font-size:15pt;" class="borde-b borde-r borde-l">
        <thead>
            <tr>
                <td style="font-size: 8px; font-family:  Arial, Helvetica, sans-serif;" class="text-center">
                    SUBTOTAL:
                </td>

                <td align="end" style=" font-size: 8px; font-family:  Arial, Helvetica, sans-serif;" class="text-center">
        ...
        <thead>
            ...
            <tr>
                ...
                <td class="borde-r borde-l borde-t borde-b">
                    <h3 style="font-size: 10px;">Consulte la validez de esta Factura Electrónica con el número de CDC
                        https://ekuatia.set.gov.py/consultas</h3>

                    <br>
                    <h4 style="font-size: 10px;"> CDC:
                        <?php
                        echo $ventas->cdc;
                        ?></h4>
                ...
                <td>
                    ...
                    QRcode::png($ventas->kude, "./qr.png", QR_ECLEVEL_L, 1, 2);
