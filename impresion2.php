...
<body id="cuerpoPagina">
    ...
    <div class="zona_impresion" style="margin-top: 125px;">
        <table border="0" align="center" width="915px" style="font-size:15pt;">
            ...
            <div style="font-size:11pt; margin-left:198px">
                <?php if ($ventas->metodopago == "Contado") { ?>
                    <div class="" style="margin-top:19px; margin-left:650px">
                        x
                    </div>
                ...
                <?php } else { ?>
                    ...
                    <div class="" style="margin-top: 19px; margin-left:766px">
                        x
                    </div>
                <?php } ?>
                ...
                <p style="margin-top: -30px;margin-left: 700px; white-space: nowrap;">
                ...
                <b>
                    <p style="font-size:12pt; white-space: nowrap;padding-bottom: 0px;margin-top: 9px; margin-left:21px">
                        <?php=
						...
						?>
						 ...
						 <?php if ($ventas->getCliente()->direccion == "") {
                    ...
                    <?php } else {
                        ...
                        echo  $ventas->getCliente()->direccion;
                ...
                <p style="margin-top: -38px; white-space: nowrap;padding-bottom: 1px; margin-left: 700px">
        ...
        <table border="0" align="center" width="912px" style="font-size:14pt;margin-top: 18px; margin-left:69px">
            <thead>
                <tr>
                                ...
                                <td style="font-size: 14px;font-family:  Arial, Helvetica, sans-serif;white-space: nowrap;"><?php
                                    ...
                                    <?php if ($ventas->VerTipoModena()->simbolo == "₲") {
                                        if ($ventas1->impuesto == 0) {
                                            ...
                                            echo number_format((($proceso->precio * $proceso->q) / 101.5 * 70), 0, ',', '.');
                                        ...
                                        if ($ventas1->impuesto == 0) {
                                            ...
                                            echo number_format(($proceso->precio * $proceso->q) / 101.5 * 70, 2, ',', '.');
                                        } else if ($ventas1->impuesto == 30) {
                                            echo number_format($proceso->precio * $proceso->q / 101.5 * 70, 2, ',', '.');
                                        } else {
                                            echo "0";
                               ...
                               <td style="font-size: 14px;font-family:  Arial, Helvetica, sans-serif;white-space: nowrap;"><?php
                                        ...
                                        <?php if ($ventas->VerTipoModena()->simbolo == "₲") {
                                            if ($ventas1->impuesto == 5) {
                                               ...
                                               echo number_format((($proceso->precio * $proceso->q) / 101.5 * 30) + (((($proceso->precio * $proceso->q) / 101.5) * 1.5)), 2, ',', '.');
                                            } else {
                                                echo "0";
                                            }
                                            echo " Gs";
        ...
        <div style="position: absolute; top: 689px;  width: 200px; z-index: 999;">
            <table border="0" class="margen-editar<?php echo $lines ?>" align="center" width="880px" style="font-size:15pt; position: sticky; top: 60px; margin-left:190px">
                <thead>
                    <tr>
        ...
        <div style="position: absolute; top: 681px ;  width: 200px; z-index: 999;">
            <table border="0" align="center" width="875px" style="font-size:15pt; margin-top: -20px; margin-left:149px">
                <thead>
                    <tr>
                        <td style="font-size: 14px; font-family:  Arial, Helvetica, sans-serif;" class="text-center">
                        </td>
        ...
        <table style="margin-left: 310px;position: absolute; top:731px;"> 
        ...
        <!-- segunda factura -->
        <div style="position: absolute; top: 980px;">
            ...
            <table border="0" align="center" width="915px" style="font-size:15pt;">
                ...
                <div style="font-size:11pt; margin-left:198px">
                    <?php if ($ventas->metodopago == "Contado") { ?>
                        <div class="" style="margin-top:5px; margin-left:650px">
                            x
                        </div>
                    ...
                    <?php } else { ?>
                        ...
                        <div class="" style="margin-top: 5px; margin-left:766px">
                            x
                        </div>
                    <?php } ?>

                    <p style="font-size:11pt;margin-top: -4px; padding-bottom: 10px;margin-left:24px">
                        <?php
                        $fecha = $ventas->fecha;
                        $fecha_formateada = date("d/m/Y", strtotime($fecha));
                        echo $fecha_formateada;
                    ...
                    <b>
                        <p style="font-size:12pt; margin-top: -5px; white-space: nowrap;padding-bottom: 0px;margin-left:60px">
                            <?php echo $ventas->getCliente()->nombre . ' ' . $ventas->getCliente()->apellido ?>

                        </p>
                    </b>
                    <p style="margin-top: -36px;margin-left: 700px; white-space: nowrap;">
                    ...
                    <p style="margin-top: -40px; white-space: nowrap;padding-bottom: 1px; margin-left: 700px">
                    ...
                    <b>
                        <p style="font-size:12pt; white-space: nowrap;padding-bottom: 1px;margin-top: 24px; margin-left:21px">
                            <?php=
                           ?>
            ...
            <table border="0" align="center" width="912px" style="font-size:14pt;margin-top: 12px; margin-left:71px">
                <thead>
                    <tr>
                        <td style="width:10%;font-family:  Arial, Helvetica, sans-serif;"><strong>
                            </strong></td>
        ...
        <div style="position: absolute; top: 1512px;  width: 200px; z-index: 999;">
            <table border="0" class="margen-editar<?php echo $lines ?>" align="center" width="865px" style="font-size:15pt; position: sticky; top: 50px; margin-left:190px">
                <thead>
                    <tr>
                        <td style="font-size: 14px; font-family:  Arial, Helvetica, sans-serif;" class="text-center">
                        </td>
        ...
        <div style="position: absolute; top: 1527px;  width: 200px; z-index: 999;">
        ...
        <table style="margin-left: 310px;position: absolute;  top: 1557px">
            <tr style="display: unset;">
