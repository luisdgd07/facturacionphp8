...
<body id="cuerpoPagina">
    ...
    ?>
    <div>
        <h3 class="borde-l borde-r borde-b borde-t">
            <h3 style="text-align: center; font-size: 25px;     font-family:  Arial, Helvetica, sans-serif;  " class="text-center"><b>Kude de Remisión Electrónica </b></h3>
        </h3>
  ...
  " class="borde-t">
            ...
            <!-- <img height="120" width="300" style="" src="./<?php echo $ventas->verSocursal()->logo ?>" alt=""> -->
            <table style="font-size:15pt;     width: 5%; ">
                <?php
                $total = 0;
                $ventas = VentaData::getById($_GET["id_venta"]);
                $procesos = OperationData::getAllProductsBySellIddd($_GET["id_venta"]);
                $sucursalDatos = $ventas->verSocursal();
                $vehiculo = VehiculoData::getId($ventas->id_vehiculo);
                $chofer = ChoferData::getId($ventas->id_chofer);
                ?>
                <thead>
                    <div style="margin:5px 0px ;">
                        <p>

                            <b style="font-size: 22px; "> BRAVO DISTRIBUIDORA S.R.L.</b>
    ...
    <h4 align="center">DATOS DEL TRASLADO</h4>
    ...
    <table border="0" width="100%">
        <thead>
            ...
            <tr>
                ...
                <td>
                    Fecha inicio del traslado: <?php echo $ventas->fecha ?>

                </td>
                <td>

                    Fecha estimada de fin de traslado: <?php echo $ventas->fecha ?>
                </td>
            </tr>
            <tr>
                <td>
                    Direccion del Punto de Partida: <?php echo $sucursalDatos->direccion ?>

                </td>
                <td>
                    Ciudad del punto de partida: <?php echo $sucursalDatos->ciudad_descripcion ?>
            ...
            <tr>
                ...
                <td>
                    ...
                    Departamento del punto de partida : <?php echo $sucursalDatos->ciudad_descripcion ?>
                </td>

                <td>
                    Kilómetros estimados de recorrido:
            ...
            <tr>
                ...
                <td>
                    Cel : <?php echo $ventas->getCliente()->telefono ?>
    ...
    <h4 align="center">DATOS DEL VEHICULO DE TRANSPORTE</h4>
    ...
    <table border="0" width="100%">
        <thead>
            ...
            <tr>
                ...
                <td>
                    Fecha estimada de inicio de traslado: <?php echo $ventas->fecha ?>

                </td>
                <td>
                    Fecha estimada de fin de traslado :
            ...
            <tr>
                ...
                <td>
                    Marca del vehículo: <?php echo $vehiculo->marca ?>

                </td>
                <td>

                    N° de identificacion del vehículo :
            ...
            <tr>
                ...
                <td>
                    N° de martircula(chapa) del vehículo : <?php echo $vehiculo->chapa_nro ?>
    ...
    <h4 align="center">DATOS DEL CONDUCTOR DEL VEHICULO</h4>
    ...
    <table border="0" width="100%">
        <thead>
            ...
            <tr>
                ...
                <td>
                    Nombre o razon social del transportista :
            ...
            <tr>
                ...
                <td>
                    Número de documento de identidad del chofer: <?php echo $chofer->cedula ?>
                </td>

                <td>
                    Nombre y apellido del chofer: <?php echo $chofer->nombre ?>
            ...
            <tr>
                ...
                <td>
                    Nombre o razon social del agente :
