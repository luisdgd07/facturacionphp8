...
$c = VentaData::getNombre4($_POST["facturan"], $_POST["sucursal_id"]);
...
if ($tipoproducto == "Servicio") {
    ...
    if (isset($_POST["cart"])) {
        if (count($cart) > 0) {
            ...
            $sell->factura_1 = $_POST['factura_1'];
            $sell->cdc_fact = $_POST['cdc_fact'];
            $sell->timbrado_fact = $_POST['timbrado_fact'];
            $sell->tipo_nota = $_POST['tipo_nota'];
            ...
            foreach ($cart as  $c2) {
                ...
                $add = $op->registro_producto1_nota();
            ...
            if ($_POST["metodopago"] == "Credito") {
                ...
                $s10 = $sell->acturalizar_estado_cleinte_nota();
