<?php
$response = [];
$ventas = VentaData::buscarVentaRemisiones($_GET['sucursal'], $_GET['offset'], $_GET['busqueda'], $_GET['desde'], $_GET['hasta'], $_GET['cliente']);
$paginas = VentaData::buscarVentaRemisionesPaginacion($_GET['sucursal'], $_GET['offset'], $_GET['busqueda'], $_GET['desde'], $_GET['hasta'], $_GET['cliente']);
    ...
    foreach ($operations as $operation) {
        ...
        if ($product->impuesto === 10) {
            ...
            $arrayIva5 = json_encode([
                ...
                "numeroSerie" => "",
                "numeroPedido" => "",
                "tipo" => ProductoData::vertipoproductoId($product->ID_TIPO_PROD)->TIPO_PRODUCTO,
                "unidadMedida" => UnidadesData::getById($product->presentacion)->nombre,
            ]);
