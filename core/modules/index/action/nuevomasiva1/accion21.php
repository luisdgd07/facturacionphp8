<?php
  ...
  $cant_productos_x_factura=floor($cantidadmasiva/$precio_producto);
  $total_venta=$_POST["total"];
  $cantidad_venta=$_POST["cantidadd"];
  $cantidad_facturas=floor($cantidad_venta/$cant_productos_x_factura);
  $monto_total_facturas = ($precio_producto*$cant_productos_x_factura)*$cantidad_facturas;
  ...
  if($monto_resto == 0){
    ...
    $total_cantidad_facturas = $cant_productos_x_factura*$cantidad_facturas;
