                ...
                <div class="box-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-2">
                      ...
                      ?>
                      <input type="text" disabled name="cambio2" id="cambio2" value="<?php echo $venta->cambio2; ?>" class="form-control">
                  ...
                  <div class="col-lg-2">
                    <input type="text" class="form-control" name="factura_1" id="factura_1" value="<?php echo $data->factura ?>">
                  </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <select name="tipo_nota" class="selectpicker show-menu-arrow" data-style="form-control" data-live-search="true" id="tipo_nota" class="form-control">
                          ...
                          <div>
                            ...
                            <select required="" name="tipomoneda_id2" id="tipomoneda_id2" id1="valor" class="form-control" oninput="tipocambio()">
                              ...
                              foreach ($monedas as $moneda) : ?>
                                ...
                                $valocito = null;
                                $i++;
                                if ($venta->tipomoneda_id == $moneda->id_tipomoneda) {
                                ?>
                ...
                <div class="col-lg-offset-2">
                  <div class="checkbox">
                    <label>
                      ...
                      <button class="btn btn-lg btn-warning" onclick="accion()"><b></b> FINALIZAR NOTA CREDITO</button></label>
                  </div>
                </div>
              </div>
              <!-- </div> -->
  ...
  <script>
    ...
    function actualizarTablacobro() {
      ...
      if (totalCobrar > totalACobrar) {
        $("#pagar").show();
        $("#total").html(totalCobrar + " Vuelto: " + (totalCobrar - totalACobrar).toLocaleString("es-ES"));
        $("#monto").val(0);
      } else {

        $("#total").html(totalCobrar + " Restante: " + (totalACobrar - totalCobrar).toLocaleString("es-ES"));
        $("#pagar").hide();
      }
    }
          ...
          if (dataResult.includes("<")) {
            ...
            if ($("#remision_id").val() == 0) {
              if (dataResult == -1) {
                ...
                // } else {
                window.location.href = "index.php?view=detalleventanota_cre&success=venta&id_venta=" + dataResult[1]
              ...
              window.location.href = "index.php?view=detalleventanota_cre&success=venta&id_venta=" + dataResult
