                ...
                <div class="box-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-2">
                      ...
                      ?>
                      <input type="text" readonly="" name="cambio2" id="cambio2" value="<?php echo $valores; ?>" class="form-control">
                  ...
                  <div class="col-lg-2">
                    ...
                    <input type="text" class="form-control" name="cdc_fact" id="cdc_fact" value="<?php echo $data->cdc_fact ?>">
                  </div>
                ...
                <div class="col-lg-offset-2">
                  <div class="checkbox">
                    <label>
                      ...
                      <button class="btn btn-lg btn-warning" onclick="accion()"><b></b> Finalizar Nota Crédito</button></label>
                  </div>
                </div>
              </div>
              <!-- </div> -->
  ...
  <script>
    ...
    function actualizarTabla() {
      ...
      if ($("#tipomoneda_id").val("US$")) {
        $("#cobror").html(parseFloat(total * $("#cambio2").val()));
