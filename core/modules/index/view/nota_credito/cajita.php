      ...
      <section class="content">
        <div class="row">
          <div class="col-xs-12">
            <div class="box">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-2">
                    <?php
                    $clients = ConfigFacturaData::verfacturasucursal10($sucursales->id_sucursal);
                    ?>
                    ...
                    <select name="configfactura_id" id="configfactura_id" class="form-control" oninput="configFactura()">
                      ...
                      foreach ($clients as $client): ?>
                        ...
                        <option <?php if ($client->comprobante1 == "Nota de Credito") {
                          echo "selected";
                  ...
                  <div class="col-lg-2">
                    ...
                    <button class="btn btn-warning" onclick="editaCambio()">Editar</button>
                    <?php
                    $cotizacion = CotizacionData::versucursalcotizacion($sucursales->id_sucursal);
                    // var_dump($cotizacion);
                    ...
                    ?>
                    <input type="text" disabled name="cambio2" id="cambio2" value="<?php echo $venta->cambio2; ?>"
                      class="form-control">
                ...
                <div class="col-lg-2">
                  ...
                  Id venta <input placeholder="Remision" value="0" disabled id="remision_id" class="form-control">
                </div>



                <?php
                $data = VentaData::getById($_GET['id']);
                ?>


                <label for="inputEmail1" class="col-lg-1 control-label">FACTURA NRO.:</label>

                <div class="col-lg-2">
                  <input type="text" class="form-control" name="factura_1" id="factura_1"
                    value="<?php echo $data->factura ?>">
                </div>

                <label for="inputEmail1" class="col-lg-1 control-label">CDC FACTURA.:</label>
                <div class="col-lg-2">



                  <input type="text" class="form-control" name="cdc_fact" id="cdc_fact" value="<?php echo $data->cdc ?>">
                </div>

              </div>

              <label for="inputEmail1" class="col-lg-1 control-label">TIMBRADO FACTURA.:</label>
              <div class="col-lg-2">



                <input type="text" class="form-control" name="timbrado_fact" id="timbrado_fact">
              </div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-lg-4">
                        <input type="date" name="fecha" class="form-control" value="<?php echo date("Y-m-d"); ?>" id="fecha"
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <label for="inputEmail1" class="selectpicker show-menu-arrow">Tipo Nota:</label>


                    <select name="tipo_nota" class="selectpicker show-menu-arrow" data-style="form-control"
                      data-live-search="true" id="tipo_nota" class="form-control">
            ...
            <h2 class="text-center">Detalle de Nota de Credito:</h2>
            <table class="table table-bordered table-hover">
              <thead>
                <th>Cantidad</th>
                <th>Codigo</th>
              ...
              <div class="col-lg-offset-2">
                <div class="checkbox">
                  <label>
                    ...
                    <button class="btn btn-lg btn-warning" onclick="accionVenta()"><b></b> FINALIZAR NOTA
                      CREDITO</button></label>
                </div>
              </div>
            </div>
            <!-- </div> -->
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Requiere clave maestra</h5>
          ...
          <div class="modal-body">
            ...
            <input type="password" placeholder="Clave" id="passUs">

          </div>
          <div class="modal-footer">
            <button type="button" data-bs-dismiss="modal" class="btn btn-danger" onclick="oculta()">Cerrar</button>
  ...
  <script type="text/javascript">
    ...
    $.ajax({
      ...
      success: function (json) {
        ...
        // $("#tipomoneda_id2").val(json[0]["moneda"]);

        // $("#cambio2").val(json[0]["cambio"])
        $("#remision_id").val(idr);
...
<script>
  ...
  function actualizarTabla() {
    ...
    setTimeout(function () {
      console.log('aaaaaaaaaaaaaaaaaaaaaaaaaaaasss1212')
      tabla = "";
      total = 0;
      grabada10 = 0;
      grabada5 = 0;
      ...
      if ($('select[name="tipomoneda_id2"] option:selected').text().includes("US$")) {
  ...
  function accion() {
    ...
    $.ajax({
      url: "index.php?action=procesoventaproducto_nota",
      type: "POST",
      data: {
        cart: carrito,
        tablaCobro: pagos,
        ...
        factura_1: $('#factura_1').val(),
        cdc_fact: $('#cdc_fact').val(),
        timbrado_fact: $('#timbrado_fact').val(),
      ...
      success: function (dataResult) {
        ...
        if (dataResult.includes("<")) {
          ...
          if ($('input[name="metodopago"]:checked').val() == "Contado") {
            ...
            console.log('data[1]', dataResult)
            pagar(dataResult);
          }
          alert("Nota de Credito realizada con exito");
          window.location.href = "index.php?view=envionotacredito&id_sucursal=" + $("#sucursal_id").val()
  ...
  function agregaTabla(id, codigo, impuesto, precio, producto, cant, tipo, stock, precioc, dep, deposito) {
    ...
    if (impuesto == 30 || impuesto == "Iva 30 Exenta 70") {
      ...
      carrito.push({
        ...
        producto: producto,
        preciot: parseFloat(totalcart).toFixed(6),
        id: id,
        tipo: tipo,
        stock: parseFloat(stock).toFixed(2),
        precioc: parseFloat(precioE).toFixed(6),
        deposito: dep,
  ...
  function ajaxOperacionTotales(simbolo$) {
    ...
    //           $("#precio_venta_" + (i + 1)).val(format(($("#precio_venta_hidden_" + (i + 1)).val() * cambio).toFixed(6)));




    //           $("#precio_total_" + (i + 1)).val(format(($("#precio_total_hidden_" + (i + 1)).val() * cambio).toFixed(6)));
