                   ...
                   <div class="form-horizontal">
                    ...
                    <div class="col-lg-9">
                     ...
                     <div class="form-group has-warning">
                       ...
                       <div class="col-sm-4">
                         <textarea name="descripcion" id="descripcion" class="form-control"><?php echo $cliente->descripcion; ?></textarea>
                       </div>
                           ...
                           <?php $unidades = UnidadesData::getAll();
                            if (count($unidades) > 0) : ?>
                             <?php if (UnidadesData::getById_($cliente->presentacion)) { ?>
                               <option value="<?php echo $cliente->presentacion ?>"><?php echo UnidadesData::getById_($cliente->presentacion)->nombre ?></option>
                             <?php } ?>
                             <?php foreach ($unidades as $unidad) : ?>
                               <option value="<?php echo $unidad->id; ?>" style="color: orange;"><i class="fa fa-gg"></i><?php echo $unidad->nombre; ?></option>
                             <?php endforeach; ?>
                           <?php endif; ?>
                         </select>
                       </div>
                     ...
                     <div class="form-group has-warning" hidden>
                       ...
                       <div class="col-sm-9">
                         <input type="text" class="form-control" id="precio_compra" name="precio_compra" maxlength="100" value="<?php echo round(($cliente->precio_compra), 4); ?>">
                       </div>
                     </div>
                     ...
                     <div class="form-group has-warning">
                       ...
                       <div class="col-sm-5">
                         <input type="text" class="form-control" id="inventario_minimo" name="inventario_minimo" maxlength="10" value="<?php echo $cliente->inventario_minimo; ?>">
                          ...
                          if (count($Tipoprod) > 0) : ?>
                           <select name="tipo_producto" id="tipo_producto" required class="form-control">
                             <?php if ($cliente->ID_TIPO_PROD) { ?>
                               <option value="<?php echo $cliente->ID_TIPO_PROD ?>"><?php echo  ProductoData::vertipoproductoId($cliente->ID_TIPO_PROD)->TIPO_PRODUCTO ?></option>
                             <?php } ?>
                             <?php foreach ($Tipoprod as $Tipoprods) : ?>
                               <option value="<?php echo $Tipoprods->ID_TIPO_PROD; ?>" style="color: orange;"><i class="fa fa-gg"></i><?php echo $Tipoprods->TIPO_PRODUCTO; ?></option>
                             <?php endforeach; ?>
                           </select>
                         <?php endif; ?>
                       </div>
                     ...
                     <div class="form-group has-feedback has-warning">
                       ...
                       <div class="col-sm-9">
                         ...
                         <input type="date" class="form-control" id="fecha_vencimiento" name="fecha_vencimiento" maxlength="100" value="<?php echo $cliente->fecha_vencimiento; ?>">
                     ...
                     <div class="form-group has-warning">
                       ...
                       <div class="col-sm-5">
                         <input type="text" class="form-control" id="precio_venta" name="precio_venta" maxlength="100" value="<?php echo round(($cliente->precio_venta), 4); ?>">
                       </div>
                     </div>
                     ...
                     <div class="form-group has-feedback has-warning">
                       ...
                       <div class="col-lg-4">
                         <input type="text" name="ganancia" id="ncm" value="<?php echo $cliente->ncm; ?>" class="form-control">

                       </div>

                       <label for="inputEmail1" class="col-lg-2 control-label">Partida Arancelaria:</label>
                       <div class="col-lg-4">
                         <input type="text" name="ganancia" id="partida_arancelaria" value="<?php echo $cliente->partida_arancelaria; ?>" class="form-control">
                       </div>
                     ...
                     <div class="form-group has-feedback has-warning">
                       ...
                       <div class="col-lg-4">
                         <input type="text" name="codigo_nivel_general" id="codigo_nivel_general" value="<?php echo $cliente->codigoNivelGeneral; ?>" class="form-control">

                       </div>

                       <label for="inputEmail1" class="col-lg-2 control-label">CodigoNivelEspecifico:</label>
                       <div class="col-lg-4">
                         <input type="text" name="codigo_nivel_especifico" id="codigo_nivel_especifico" value="<?php echo $cliente->codigoNivelEspecifico; ?>" class="form-control">
                       </div>
                     ...
                     <div class="form-group has-feedback has-warning">
                       ...
                       <div class="col-lg-4">
                         <input type="text" name="codigo_gtin_producto" id="codigo_gtin_producto" value="<?php echo $cliente->codigoGtinProducto; ?>" class="form-control">

                       </div>

                       <label for="inputEmail1" class="col-lg-2 control-label">Codigo Nivel Paquete:</label>
                       <div class="col-lg-4">
                         <input type="text" name="codigo_nivel_paquete" id="codigo_nivel_paquete" value="<?php echo $cliente->codigoNivelPaquete; ?>" class="form-control">
                       </div>
                     ...
                     <div class="modal-footer">
                       ...
                       <input type="hidden" name="sucursal_id" id="sucursal_id" value="<?php echo $_GET["id_sucursal"]; ?>">
   ...
   <script>
    ...
    `;
     ...
     function accion() {
	   ...
	   let partida_arancelaria = $("#partida_arancelaria").val();
	      let codigo_nivel_general = $("#codigo_nivel_general").val();
		     let codigo_nivel_especifico = $("#codigo_nivel_especifico").val();
			  let codigo_gtin_producto = $("#codigo_gtin_producto").val();
			  	  let codigo_nivel_paquete = $("#codigo_nivel_paquete").val();
				    let ncm = $("#ncm").val();
