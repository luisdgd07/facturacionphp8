                 ...
                 <div class="panel-body">
                   <div class="form-horizontal">
                     ...
                     <div class="form-group has-feedback has-warning">
                       ...
                       <div class="col-lg-4">
                         <select name="cliente" required onchange="clienteTipo()" class="selectpicker show-menu-arrow form-control" data-style="form-control" data-live-search="true" id="cliente_id" class="form-control">
                       ...
                       <div class="col-lg-4">
                         <input type="text" name="entrega" value="0" class="form-control" id="entrega" maxlength="800" required>
                         <span class="fa fa-sort-amount-desc form-control-feedback"></span>
                       </div>
                     ...
                     <div class="form-group has-feedback has-warning">
                       ...
                       <div class="col-lg-4">
                         <input type="text" name="anticipo" value="0" class="form-control" id="anticipo" maxlength="800" required>
                         <span class="fa fa-dollar form-control-feedback"></span>
                       </div>
                     </div>
                     <div class="form-group has-feedback has-warning">
                       ...
                       <div class="col-lg-4">
                         <textarea id="" cols="30" rows="10" name="descripcion" class="form-control" placeholder="Solo puede ingresar 500 caracteres" maxlength="500" required></textarea>
                         <span class="fa fa-dollar form-control-feedback"></span>
                       </div>
                     ...
                     <div class="form-group">
                       <div class="col-lg-offset-2 col-lg-10">
                         ...
                         <button type="submit" class="btn btn-warning btn-flat" name="add" id="accion"><i class="fa fa-save"></i> Guardar</button>
                       </div>
                     </div>
                     <div id="insumos"></div>
                   </div>
