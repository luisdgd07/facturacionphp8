                                    ...
                                    <div class="box">
                                        <div class="box-body">
                                            ...
                                            ?>
                                                ...
                                                <br>
                                                <button onclick="consultaLote(110835326395411473)" class="btn btn-primary">Consultar lote</button>
                                                <br>
                                                <hr>
                                                <br>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                if ($sell->enviado == "Aprobado") {
                                                                    ...
                                                                    $tipo_remision = $sell->tipo_remision;
                                                                                              ...
                                                                                              transporte : {
                                                                                               ...
                                                                                               entrega : {
                                                                                                ...
                                                                                                vehiculo : {
                                                                                                    ...
                                                                                                    documentoTipo : 1, 
                                                                                                    documentoNumero :"<?php echo $vehiculo->chapa_nro ?>",
                                                                                                    obs : "",
                                                                                                    numeroMatricula : "<?php echo $vehiculo->chapa_nro ?>",
                                                                                                    numeroVuelo : 0
                                                                                                },
                                                                                                transportista : {
                                                                                                    contribuyente : true,
                                                                                                    nombre : "<?php if (is_null($venta->fletera_id)) {
                                                                                                                    echo $sucursalDatos->razon_social;
                                                                                                                } else {
                                                                                                                    echo $fleteraN;
                                                                                                                } ?>",
                                                                                                    ruc : "<?php
                                                                                                            if (is_null($venta->fletera_id)) {
                                                                                                                echo $sucursalDatos->ruc;
                                                                                                            } else {
                                                                                                    ...
                                                                                                    direccion :"<?php
                                                                                                                if (is_null($venta->fletera_id)) {
                                                                                                                    echo $sucursalDatos->direccion;
                                                                                                                } else {
                                                                                                                    echo $fletera->direccion;
                                                                                                                } ?>",
                                                                                                    obs : 1,
                                                                                                    pais : "PRY",
                                                                                                    paisDescripcion : "Paraguay",
                                                            ...
                                                            <td>
                                                                ...
                                                                ?>
                                                                <?php if ($sell->enviado == "Rechazado" || $sell->enviado == "Aprobado" || $sell->enviado == "Cancelado") {
                                                                    $venta = VentaData::getById($sell->id_venta);
                                                                    $telefonoEmisor =  $venta->verSocursal()->telefono;
                                                                    $rucEmisor = $venta->verSocursal()->ruc;
                                                                    $direccionCliente = $venta->getCliente()->direccion;
...
<script>
    ...
    function enviar() {
        ...
        $.ajax({
            ///url: "http://syscomdl.com/enviarlote",
            ...
            data: {
                ...
                tipoOperacion: "<?php echo $tipoOperacion ?>",
