            ...
            <div class="box">
              <div class="box-body">
                ...
                <div class="table-responsive">
                  <?php
                  $users = ProductoData::getAll($_GET["id_sucursal"]);
                  if (count($users) > 0) {
                    // si hay usuarios
                    ?>
                      ...
                      <tbody>
                        ...
                        foreach ($users as $user) {
                          ...
                          <tr>
                            ...
                            <td style="width:70px;">
                              <a href="index.php?view=stock_depos&id_sucursal=<?php echo $sucursales->id_sucursal; ?>&product_id=<?php echo $user->id_producto; ?>&nombre=<?php echo $user->nombre; ?>&codigo=<?php echo $user->codigo; ?>"
                                class="btn btn-xs btn-default"><i class="glyphicon glyphicon-eye-open"
                                  style="color: orange;"></i> VER STOCK</a>
