                ...
                <script>
                    function exportar() {
                        ...
                        if (product == '' || date1 == '' || date2 == '' || cliente == '' || tipofactura == '') {
                            ...
                            window.location.href = `libroVenta1.php?&uso_id=&sd=${date1}&ed=${date2}&id_sucursal=${id_sucursal}&cliente=${cliente}&type=${tipofactura}&prod=${product}&venta=${document.getElementById("tipoventa").value}`;
                    ...
                    function exportar2() {
                        ...
                        if (product == '' || date1 == '' || date2 == '' || cliente == '' || tipofactura == '') {
                            ...
                            window.location.href = `csvVenta.php?&uso_id=&sd=${date1}&ed=${date2}&id_sucursal=${id_sucursal}&cliente=${cliente}&type=${tipofactura}&prod=${product}&venta=${document.getElementById("tipoventa").value}`;
                    ...
                    function exportar3() {
                        ...
                        if (product == '' || date1 == '' || date2 == '' || cliente == '' || tipofactura == '') {
                            ...
                            window.location.href = `index.php?view=libroventa&uso_id=&sd=${date1}&ed=${date2}&id_sucursal=${id_sucursal}&cliente=${cliente}&type=${tipofactura}&prod=${product}&venta=${document.getElementById("tipoventa").value}`;
