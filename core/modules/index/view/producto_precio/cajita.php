			 ...
			 $descrip_moneda= "";
              ...
              <table id="example1" class="table table-bordered table-dark" style="width:100%">
                ...
                <tbody>
                  ...
                  <td style="width:150px;">
                    <a href="index.php?view=actualizarprecio&id_sucursal=<?php echo $sucursales->id_sucursal;?>&id_precio=<?php echo $preciopro->PRECIO_ID ;?>&id_producto=<?php echo $preciopro->PRODUCTO_ID ;?>" data-toggle="modal" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-cog"></i> Editar</a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
              <h4 class="modal-title"><i class="fa fa-steam-square" style="color: orange;"></i><b style="color: black;"> Agregar Nuevo Precio de producto</b></h4>
            </div>
            <div class="modal-body">
              <form class="form-horizontal" action="index.php?action=nuevolistaprecioproducto" role="form" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-sm-9">
					 ...
					 <?php
                            ...
                            <select name="id_producto" id="id_producto" required class="form-control">
                              ...
                              <option value="<?php echo $products->id_producto; ?>" style="color: orange;"><i class="fa fa-gg"></i> <?php    echo $products->nombre;  ?> </option>
                    ...
                    <div class="col-sm-9">
					 ...
					 <?php
                            ...
                            <select name="id_precio" id="id_precio" required class="form-control">
                              ...
                              <option value="<?php echo $lista->PRECIO_ID ; ?>" style="color: orange;"><i class="fa fa-gg"></i> <?php    echo $lista->NOMBRE_PRECIO;  ?> </option>
