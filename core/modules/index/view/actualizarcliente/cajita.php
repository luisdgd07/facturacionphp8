        ...
        <div class="box-body">
          <div class="panel-body">
            <form class="form-horizontal" enctype="multipart/form-data" method="post"
              action="index.php?action=actualizarcliente" role="form">
              <!--  -->
              ...
              <center>
                <div>
                  <img src="storage/cliente/<?php echo $cliente->imagen; ?>" class="img-responsive img-circle" alt=""
                    with-border="100$" width="30%" height="30%">
                </div>
              </center>
              <div class="form-group has-warning has-feedback">
                <label for="inputEmail1" class="col-lg-2 control-label"><i class="fa fa-times-circle-o"></i>
                  Nombre</label>
                <div class="col-lg-10">
              ...
              <div class="form-group has-feedback has-warning">
                ...
                <div class="form-group has-feedback has-warning">
                  ...
                  <div class="col-sm-4">
                    <select class="form-control" name="tipo_operacion">
                      <option value="<?php echo $cliente->tipo_operacion; ?>"><?php echo $cliente->tipo_operacion; ?>
                      </option>
                ...
                <label for="inputEmail1" class="col-lg-2 control-label"><i class="fa fa-times-circle-o"></i> N°
                  Documento</label>
                <div class="col-lg-4">
              ...
              <div class="form-group has-warning has-feedback">
                <label for="inputEmail1" class="col-lg-2 control-label"><i class="fa fa-times-circle-o"></i> Tipo de
                  cliente</label>
                <div class="col-lg-10">
                  <select name="id_precio" id="id_precio" class="form-control">
                    ...
                    foreach ($clients as $client):
                      ...
                      if ($cliente->id_precio == $client->PRECIO_ID) {
                        ?>
                        <option selected value="<?php echo $client->PRECIO_ID; ?>"><?php echo $client->NOMBRE_PRECIO ?>
                        </option>
                      <?php } else {
                        ?>
              ...
              <div class="form-group">
                ...
                <div class="form-group has-warning has-feedback">
                  <label for="inputEmail1" class="col-lg-2 control-label"><i
                      class="fa fa-times-circle-o"></i>Estado</label>
              ...
              <div class="form-group has-warning has-feedback">
                <label for="inputEmail1" class="col-lg-2 control-label"><i class="fa fa-times-circle-o"></i> Días crédito
                  cliente</label>
                <div class="col-lg-10">
                  <input type="text" class="form-control" name="dias_credito" id="dias_credito"
                    value="<?php echo $cliente->dias_credito; ?>">
                  <span class="fa fa-google-plus form-control-feedback"></span>
                </div>
              </div>
              ...
              <div class="form-group">
                <div class="col-lg-offset-2 col-lg-12">
                  ...
                  <button type="submit" class="btn btn-warning "><i class="fa fa-cog fa-spin fa-1x fa-fw"></i> Actualizar
                    Datos</button>
                  <button type="reset" class="btn btn-info "><i class="fa fa-eraser fa-spin fa-1x fa-fw"></i>
                    Borrar</button>
                </div>
              </div>
            </form>
