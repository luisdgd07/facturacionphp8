                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <?php if ($sell->enviado == "Rechazado") { ?>
                                                                    <!-- <button onclick="kude(<?php echo $sell->id_venta ?>)">Descargar Kude</button> -->
                                                                    <a class="btn btn-primary" href="./impresionkude.php?id_venta=<?php echo $sell->id_venta; ?>">A4</a>
                                                                    <a class="btn btn-primary" href="./impresionkudeticket.php?id_venta=<?php echo $sell->id_venta; ?>">Ticket</a>
...
<script>
    ...
    function enviar() {
        ...
        //     nombreFantasia: "DE generado en ambiente de prueba - sin valor comercial ni fiscal",
        ...
        let data1 = {
            ...
            establecimientos: [{
                ...
                ciudad: "<?php echo $sucursalDatos->ciudad_descripcion ?>",
        ...
        $.ajax({
            ...
            data: {
                ...
                cert: '../<?php echo $sucursalDatos->certificado_url ?>',
                // cert: '../facturacionElectronica/3997053.pfx',
                // cert: './3997053.pfx',
                logo: "<?php echo $sucursalDatos->logo ?>",
                pass: "<?php echo $sucursalDatos->clave ?>",
                data1: datos
                // fechaFirma: '2022-07-5',
                // rucEmisor: '3997053-1',
                // razonSocial: 'DE generado en ambiente de prueba - sin valor comercial ni fiscal',
                // nombreFantasia: 'DE generado en ambiente de prueba - sin valor comercial ni fiscal',
                // codAct: '62010',
                // desAct: 'ACTIVIDADES DE PROGRAMACIÓN INFORMÁTICA',
                // timbrado: "12559590",
                // fechaTimbrado: "2022-06-21",
                // contriEstable: 2,
                // regimenEstable: 8,
                // codEstable: "001",
                // dirEstable: "Barrio Carolina",
                // nCasaEstable: 1937,
                // comDirEstable: "11 DE SETIEMBRE 1937 CASI HUMAITA",
                // comDirEstable2: "11 DE SETIEMBRE 1937 CASI HUMAITA",
                // depEstable: 1,
                // depDesEstable: "CAPITAL",
                // disEstable: 12,
                // desDisEstable: "ASUNCION (DISTRITO)",
                // CiuEstable: 1,
                // CiuDesEstable: "ASUNCION (DISTRITO)",
                // telEstable: "1234567",
                // emailEstable: "DIELOSI@GMAIL.COM",
                // denEstable: "Sucursal 1"
            ...
            success: function(dataResult) {
                ...
                try {
                    ...
                    Swal.fire({
                        title: `Lote: ${lote} enviado, obteniendo resultados`,
                        icon: 'info',
                    })
                    consultaLote(lote);
                } catch (e) {
    ...
    function consultadeLote() {
        $.ajax({
            ...
            success: function(dataResult) {
                ...
                //             xml: xmlsenviados[i]
                //         });
                //         textoLote += "Venta: " + ventas[i] + " " + lotesenviados[i]["ns2:dEstRes"] + "\n"
                //     }
                //     $.ajax({
                ...
                //             console.log("Ha ocurrido un error.", x);
                //         }
                //     });
                //     // Swal.fire({
                //     //     title: textoLote,
