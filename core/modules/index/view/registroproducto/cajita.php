          ...
          <div class="box">
            ...
            <div class="box-body">
              <div class="box box-warning">
                    ...
                    <form class="form-horizontal" role="form" method="post" action="index.php?action=nuevoproducto" enctype="multipart/form-data">
                      <div class="form-group has-feedback has-error">
                        ...
                        <div class="form-group has-feedback has-warning">
                          ...
                          <div class="col-lg-4">
                            <input type="text" name="precio_venta" class="form-control" id="precio_venta" placeholder="Precio de Venta" onkeypress="return solonumeross(event)" required="">
                        ...
                        <hr>
                        <div class="form-group has-feedback has-warning">
                          <label for="inputEmail1" class="col-lg-2 control-label">10%</label>
                          <div class="col-lg-2">
                            <input type="text" name="precio_venta" class="form-control" id="precio_venta" placeholder="Grabada 10%" onkeypress="return solonumeross(event)" required="">
                            <span class="fa fa-dollar form-control-feedback"></span>
                          </div>
                          <label  class="col-lg-2 control-label">5%</label>
                          <div class="col-lg-2">
                            <input type="text" name="precio_compra" class="form-control" id="precio_compra" onkeypress="return solonumeross(event);" placeholder="Grabada 5%" maxlength="800">
                            <span class="fa fa-dollar form-control-feedback"></span>
                          </div>
                          <label  class="col-lg-2 control-label">0%</label>
                          <div class="col-lg-2">
                            <input type="text" name="precio_compra" class="form-control" id="precio_compra" onkeypress="return solonumeross(event);" placeholder="Excelto" maxlength="800">
                            <span class="fa fa-dollar form-control-feedback"></span>
                          </div>
                        </div>
                        <!-- <div class="form-group has-feedback has-error">
