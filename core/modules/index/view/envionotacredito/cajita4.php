            ...
            <div class="content-wrapper">
                    ...
                    <section class="content">
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                ...
                                ?>
                                    <button onclick="exportar()" href="" class="mx-4 my-2 btn btn-success">Generar PDF 1</button>
                                    <button onclick="exportar5()" href="" class="mx-4 my-2 btn btn-success">Generar PDF 2</button>
                                    <button onclick="exportar4()" href="" class="mx-4 my-2 btn btn-success">Generar Excel </button>
                                    <button onclick="exportar2()" href="" class="mx-4 my-2 btn btn-success">Generar Excel A EXPORTAR</button>
                                    <?php
                ...
                <script>
                    ...
                    function exportar3() {
                        ...
                        window.location.href = `index.php?view=libroventag&uso_id=&sd=${date1}&ed=${date2}&id_sucursal=${id_sucursal}&prod=${product}&producto=${producto}&venta=${v}&cliente=${cliente}&vendedor=${vendedor}`;
