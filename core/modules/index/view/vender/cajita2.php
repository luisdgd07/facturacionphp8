                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-lg-4">
                            <input type="date" name="fecha" class="form-control" value="<?php echo $fechaActual; ?>" id="fecha" placeholder="Efectivo">
                          </div>
                        </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <div class="col-lg-4">
                          <select class="selectpicker show-menu-arrow" data-style="form-control" data-live-search="true" id="transaccion" class="form-control">
