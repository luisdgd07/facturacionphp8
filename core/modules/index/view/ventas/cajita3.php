                                    ...
                                    ?>
                                        ...
                                        <table id="example1" class="table table-bordered table-hover  ">
                                            ...
                                            <thead>
                                                ...
                                                <th width="120px">Sifen</th>
                                                <th width="120px">Correo</th>

                                                <th width="120px">Kude</th>
                                                        ...
                                                        ?>
                                                            ...
                                                            if ($venta->tipo_venta == 5) { ?>
                                                                ...
                                                                <?php
                                                                        ...
                                                                        if ($sucursalDatos->tipo_recibo == 0) { ?>
                                                                <button class="btn btn-primary" onclick='kude(<?php echo json_encode($productosItem) ?>,"<?php echo $venta->cdc ?>","<?php echo $venta->factura ?>","<?php echo $venta->fecha_envio ?>","<?php echo $venta->metodopago ?>","<?php echo $rucCLiente  ?>",<?php echo $cambio;  ?>,"<?php echo $cliente ?>","<?php echo $moneda; ?>","<?php echo $direccionCliente; ?>","<?php echo $telefono; ?>",<?php echo $venta->iva10; ?>,<?php echo $venta->iva5; ?>,0,"<?php echo $client->email; ?>")'>Enviar</button>


                                                            <?php }
                                                                        if ($sucursalDatos->tipo_recibo == 1) { ?>
                                                                <button class="btn btn-primary" onclick='kude(<?php echo json_encode($productosItem) ?>,"<?php echo $venta->cdc ?>","<?php echo $venta->factura ?>","<?php echo $venta->fecha_envio ?>","<?php echo $venta->metodopago ?>","<?php echo $rucCLiente  ?>",<?php echo $cambio;  ?>,"<?php echo $cliente ?>","<?php echo $moneda; ?>","<?php echo $direccionCliente; ?>","<?php echo $telefono; ?>",<?php echo $venta->iva10; ?>,<?php echo $venta->iva5; ?>,1,"<?php echo $client->email; ?>")'>Enviar</button>
                                                            <?php } ?>
    ...
    <script>
        function kude(items, cdc, factura, fecha, condicion, rucCliente, cambio, cliente, moneda, direccion, telefono, iva10, iva5, tipo, email, tiporemi, usuario, marca, chapa, chofer, dircho, cicho) {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    tipoFactura: 'Remisión Electronica',
                    factura: factura,
                    fechaEmision: fecha,
                    condicion: condicion,
        ...
        function kudedescargar(items, cdc, factura, fecha, condicion, rucCliente, cambio, cliente, moneda, direccion, telefono, iva10, iva5, tipo, email, tiporemi, usuario, marca, chapa, chofer, dircho, cicho) {
        ...
        function kude2(items, cdc, factura, fecha, condicion, rucCliente, cambio, cliente, moneda, direccion, telefono, iva10, iva5, tipo, email, cdcA) {
            console.log(items)
            Swal.fire({
                title: 'Enviando correo',
                icon: 'info',
            ...
            $.ajax({
                ...
                data: {
                    ...
                    distrito: '<?php echo $sucursalDatos->distrito_descripcion ?>',
                    rucSuc: '<?php echo $sucursalDatos->ruc ?>',
                    tipoFactura: 'Factura Electronica',
                    factura: factura,
                    fechaEmision: fecha,
                    condicion: condicion,
                    rucCliente: rucCliente,
