        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body">
             ...
             <?php
                $configfacturas = FleteraData::listar($sucursales->id_sucursal);
              ...
              <table id="example1" class="table table-bordered table-dark" style="width:100%">
                ...
                <tbody>
                  <?php
                    ...
                    ?>
                  <tr>
                  <td><?php echo $configfactura->id_empresa_flete; ?></td>
                  <td><?php echo $configfactura->nombre_empresa; ?></td>
                  ...
                  <td style="width:150px;">
                    <a href="index.php?view=actualizarfletera&id_sucursal=<?php echo $sucursales->id_sucursal;?>&id_empresa_flete=<?php echo $configfactura->id_empresa_flete;?>" data-toggle="modal" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-cog"></i> Editar</a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title"><i class="fa fa-steam-square" style="color: orange;"></i><b style="color: black;"> Agregar nueva Empresa Fletera</b></h4>
            </div>
            <div class="modal-body">
              <form class="form-horizontal" action="index.php?action=creafletera" role="form" method="post" enctype="multipart/form-data">
