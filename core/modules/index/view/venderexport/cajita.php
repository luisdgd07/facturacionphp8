                    ...
                    <div class="col-lg-2">
                      ...
                      <select name="agente" id="agente" id1="valor" class="form-control">
                        ...
                        <?php foreach ($agentes as $agente) : ?>
                          <option value="<?php echo $agente->id_agente; ?>" <?php if (isset($venta) && $venta->agente_id == $agente->id_agente) echo 'selected'; ?>>
                            ...
                            <div class="col-lg-6">
                              <select name="cliente_id" id="chofer_id" class="form-control">
                                ...
                                foreach ($choferes as $chofer) : ?>
                                  ...
                                  <option value="<?php echo $chofer->id_chofer; ?>" <?php if ($venta->id_chofer == $chofer->id_chofer) echo 'selected'; ?>>
