          ...
          <div class="col-xs-12">
            <div class="box">
              ...
              <div class="box-body">
                <?php
                if (isset($_GET['tid'])) {
                  $venta = VentaData::getByIdInTable($_GET['tid'], 'remision');
                }
                ...
                <div class="form-group">
                  ...
                  <div class="row ">
                    ...
                    <div class="col-lg-3">
                      ...
                      <select id="tipoExportacion" class="form-control">

                        <option value="20">Exportación</option>
                        <option value="50">Maquila</option>
                  ...
                  <div class="col-lg-2">
                    ...
                    <select name="agente" id="agente" id1="valor" class="form-control">
                      ...
                      <?php foreach ($agentes as $agente): ?>
                        <option value="<?php echo $agente->id_agente; ?>" <?php if (isset($venta) && $venta->agente_id == $agente->id_agente)
                             echo 'selected'; ?>>
                          <?php echo $agente->nombre_agente ?>
                        </option>
                      <?php endforeach; ?>
                    </select>
                  </div>
                          ...
                          <div class="col-lg-6">
                            <select name="cliente_id" id="chofer_id" class="form-control">
                              ...
                              foreach ($choferes as $chofer): ?>
                                ...
                                <option value="<?php echo $chofer->id_chofer; ?>" <?php if ($venta->id_chofer == $chofer->id_chofer)
                                     echo 'selected'; ?>>
                                  <?php echo $chofer->cedula . " - " . $chofer->nombre ?>
                                </option>
                              <?php endforeach; ?>
                            </select>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <div class="col-lg-4">
                          <input name="metodopago" value="Contado" checked type="radio" name="" onclick="Ocultar3();">
                          Contado
                  ...
                  <?php if (isset($_GET['tid'])) { ?>
                    <div class="row">
                      <div class="col-md-6">
                        <?php $venta = VentaData::getByIdInTable($_GET['tid'], 'remision');
                        ?>
                  ...
                  <div class="col-md-6 col-md-offset-6">
                    <table class="table table-bordered">
                      <tr>
                        ...
                        <td>
                          <p><b> <input type="text" readonly="" name="total10" id="total10" placeholder="Efectivo"
                                value="0">
                            </b></p>
                        </td>
                        <td>IVA. 10%</td>
  ...
  function actualizarTabla() {
    ...
    for (const [id, cart] of Object.entries(carrito)) {
      ...
      if (cart.impuesto == 10) {
        ...
        exenta += parseFloat(cart.preciot);
      }
  ...
  function accion() {
    ...
    $.ajax({
      ...
      data: {
        ...
        pesob: $("#pesob").val(),
        peson: $("#peson").val(),
        tipoExportacion: $('#tipoExportacion').val()
      },
      success: function (dataResult) {
