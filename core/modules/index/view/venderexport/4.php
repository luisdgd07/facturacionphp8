              ...
              <div class="box box-warning">
                <?php if(isset($_SESSION["cart"])):
                  ...
                  <tr>
                    ...
                    <td><p><b> <input type="text" readonly="" name="total10"  id="total10" placeholder="Efectivo" value="<?php echo round($grabada10); ?>"> 
                    </b></p></td>
                    <td>IVA. 10%</td>
                    <td><p><b> <input type="text" readonly="readonly" name="iva10" value="<?php echo round($iva10); ?>">  
                  </tr>
                  <tr>
                    <td><p>Grabada 5%</p></td>
                    <td><p><b><input type="text" readonly="" name="total5" value="<?php echo round($grabada5); ?>"> </b></p></td>
                    <td>IVA. 5%</td>
                    <td><p><b><input type="text" readonly="" name="iva5" value="<?php echo round($iva5); ?>">  
                  </tr>
                  <tr>
                    <td><p>Exenta</p></td>
                    <td><p><b><input type="text" readonly="" name="exenta" value="<?php echo round($grabada0); ?>"> </b></p></td>
                  </tr>
                  <tr>
                    <td><p>Total</p></td>
                  ...
                  <div class="form-group">
                      ...
                      <a href="index.php?action=eliminarcompraproductos1&id_sucursal=<?php echo $sucursales->id_sucursal;?>" class="btn btn-lg btn-danger"><i class="glyphicon glyphicon-remove"></i> Cancelar</a>
                            <button class="btn btn-lg btn-warning"><b></b> Finalizar Venta</button>
