...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <div class="row">
      ...
      <div class="col-xs-12">
        <form method="post" action="index.php?action=creafletera" role="form">
          <div class="box">
            <div class="box-body">
                ...
                <div class="panel-body">
                  <div class="form-horizontal">
                    ...
                    <div class="form-group has-feedback has-warning">
                      ...
                      <div class="col-lg-4">
                        <input type="text" name="ruc" class="form-control" id="monto" maxlength="800" required>
                    ...
                    <div class="form-group has-feedback has-warning">
                      ...
                      <div class="col-lg-4">
                        <input type="text" name="telefono" class="form-control" id="monto" maxlength="800" required>
                        <span class="fa fa-laptop form-control-feedback"></span>
                      </div>
