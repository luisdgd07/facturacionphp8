                  ...
                  <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="treeview">
                      ...
                      <ul class="treeview-menu">
                        ...
                        <?php if ($u->opciones == 1) { ?>
                          ...
                          <li><a href="index.php?view=listadocontratoscliente2&id_sucursal=<?php echo $sucursal->id_sucursal; ?>"><i class="fa fa-money" style="color: orange;"></i>listado conceptos x Contratos</a></li>

                          <li><a href="index.php?view=asignarcontrato&id_sucursal=<?php echo $sucursal->id_sucursal; ?>"><i class="fa fa-money" style="color: orange;"></i>Asignar Contrato a venta</a></li>
                    ...
                    <li class="treeview">
                      ...
                      <ul class="treeview-menu">
                        ...
                        <li><a href="index.php?view=remision1&id_sucursal=<?php echo $sucursal->id_sucursal; ?>"><i class="fa fa-money" style="color: orange;"></i> Remisiones pendientes ventas locales</a></li>
						<li><a href="index.php?view=remisionexport&id_sucursal=<?php echo $sucursal->id_sucursal; ?>"><i class="fa fa-money" style="color: orange;"></i> Remisiones pendientes ventas de exportacion</a></li>
                    ...
                    <li class="treeview">
                      ...
                      <ul class="treeview-menu">
                        ...
                        <li><a href="index.php?view=ventasexportacion&id_sucursal=<?php echo $sucursal->id_sucursal; ?>"><i class="fa fa-cart-plus" style="color: orange;"></i>Exportaciones</a></li>
                        <li><a href="index.php?view=envioexportacion&id_sucursal=<?php echo $sucursal->id_sucursal; ?>"><i class="fa fa-cart-plus" style="color: orange;"></i>Enviar exportación.</a></li>
        ...
        <?php if (isset($_SESSION["admin_id"]) && $_SESSION["admin_id"] != "") : ?>
          ...
          <footer class="main-footer">
            <div class="pull-right hidden-xs">
              Copyright &copy; 2022 <a href="https://rconsultores.com.py" target="_blank"> <b> VALOR CONTABLE</b></a>
              <b>Version</b> 1.0
            </div>
            <strong>
              <h1> </h1>
