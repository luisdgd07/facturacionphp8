                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-lg-2">
                          ...
                          ?>
                          <select onchange="moneda()" required="" name="tipomoneda_id" id="tipomoneda_id" id1="valor" class="form-control" oninput="tipocambio()">
                        ...
                        <div class="col-lg-2">
                          ...
                          <input placeholder="111" name="idtipomoneda" id="idtipomoneda" class="form-control">
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-md-6">
