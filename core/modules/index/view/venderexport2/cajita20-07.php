      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          <div class="row">
              ...
              <div class="box">
                <div class="box-body">
				  ...
				  $cotizacion = CotizacionData::versucursalcotizacion($sucursales->id_sucursal);
                    $cajas = CajaData::vercajapersonal($u->id_usuario, $sucursales->id_sucursal);
			...
			//$valor2 = MonedaData::VerId_simbol($sucursales->id_sucursal);
			//if(  count($cotizacion)>0){
			//foreach($valor2 as $valor3):
			
			
			//$valores = $valor3->valor;
			...
			// if ($simbolo=="US$") {$sell->cambio2 = $valores;
...
?>
                      ...
                      <?php if(isset($_SESSION["cart"])):
                        ...
                        <tr >
						  ...
						  <td ><input  style="width:110px;" readonly="" type="text"  name="codigo_" id="codigo_<?=$total_registros+1?>" value="<?php echo $product->codigo;?>"></td>
                         
						  
						   <td ><span>
                            <input style="width:90px;" 
                            onblur="actualizarCantidad(<?=$total_registros+1?>, '<?php echo $product->nombre; ?>', <?php echo $p["precio"] ?>, <?php echo $p['producto_id'];?>)"
                          ...
                          <td>
                            ...
                            <?php
                              ...
                              switch($product->impuesto){
                                case 10:
                                  $resultado_valor = round((($p["precio"]*$p["q"])/11),4);$iva10+=round((($p["precio"]*$p["q"])/11),4);
                                  break;
                                case 5:
                                  $resultado_valor = round((($p["precio"]*$p["q"])/21),4);$iva5+=round((($p["precio"]*$p["q"])/21),4);
                                  break;
                                default:
                                  $resultado_valor = round((($p["precio"]*$p["q"])),4);$iva0+=round((($p["precio"]*$p["q"])),4);
                              }
                          ...
                          <td>
                            ...
                            <?php
                              ...
                              switch($product->impuesto){
                                case 10:
                                  $resultado_valor = round((($p["precio"]*$p["q"])/1.1),4);$grabada10+=round((($p["precio"]*$p["q"])/1.1),4);
                                  break;
                                case 5:
                                  $resultado_valor = round((($p["precio"]*$p["q"])/1.05),4);$grabada5+=round((($p["precio"]*$p["q"])/1.05),4);
                                  break;
                                default:
                                  $resultado_valor = round((($p["precio"]*$p["q"])),4);$grabada0+=round((($p["precio"]*$p["q"])),4);
                              }
                              echo $resultado_valor; 
                            ?>
                          </b>
  ...
  <!--*********** -->   
						   ...
						   <td ><span>
                            ...
                            onblur="actualizarCantidad2(<?=$total_registros+1?>, '<?php echo $p["q"] ?>', <?php echo round(($p["precio"]),4) ?>, <?php echo $p['producto_id'];?>)"
                             type="text" id="precio_venta_<?=$total_registros+1?>" 
                          ...
                          <td>
                            <input style="width:110px;"  readonly="" type="text" name=""  id="precio_total_<?=$total_registros+1?>" value="<?php  $pt = round(($p["precio"]*$p["q"]),4); $total1 +=$pt; echo round(($p["precio"]*$p["q"]),4); ?>">
                            <input  readonly="" type="hidden" name="" id="precio_total_hidden_<?=$total_registros+1?>" value="<?php  $pt = round(($p["precio"]*$p["q"]),4); echo  round(($p["precio"]*$p["q"]),4); ?>">
                          </td>
