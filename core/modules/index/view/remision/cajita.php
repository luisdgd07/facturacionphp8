              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-2">
                    ...
                    <select name="configfactura_id" id="configfactura_id" class="form-control" oninput="configFactura()">
                      ...
                      <?php foreach ($clients as $client): ?>
                        <option selected <?php if ($client->diferencia == -1): ?>disabled="" <?php else: ?><?php endif ?>
                  ...
                  <div class="col-lg-2">
                    ...
                    ?>
                    <input readonly="" type="text" name="cambio2" id="cambio2" value="<?php echo $valores; ?>"
                      class="form-control">
                  ...
                  <div class="col-md-6" style="margin-top: 15px;">
                    <div id="ocultar">
                      <div class="form-group">
                        ...
                        <div class="col-lg-9">
                          ...
                          <input name="formapago" autofocus="autofocus" value="ninguno" checked type="radio" name=""
                    ...
                    <div id="mostrar">
                      <div class="form-group" hidden>
                        ...
                        <div class="col-lg-9">
                          <input type="number" id="vencimiento" value="30" name="vencimiento" class="form-control"
                            id="plazo">
                        </div>
                ...
                <div class="row">
                          ...
                          <select name="cliente_id" id="chofer_id" class="form-control">
                            ...
                            foreach ($choferes as $chofer): ?>
                              <option value="<?php echo $chofer->id_chofer; ?>">
                                <?php echo $chofer->cedula . " - " . $chofer->nombre ?></option>
                            <?php endforeach;
                            ?>
                          </select>
                        </div>
                  ...
                  <div class="col-lg-4">
                    ...
                    <select name="fletera" id="fletera" id1="valor" class="form-control">
                      ...
                      <?php foreach ($agentes as $agente): ?>
                        <option value="<?php echo $agente->id_empresa_flete; ?>"><?php echo $agente->nombre_empresa ?>
                        </option>
                      <?php endforeach; ?>
                    </select>
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="col-lg-6">
                      ...
                      <select name="cliente_id" onchange="" class="selectpicker show-menu-arrow" data-style="form-control"
                          ...
                          <select name="cliente_id" id="vehiculo_id" class="form-control">
                            ...
                            foreach ($ves as $ve): ?>
                              <option value="<?php echo $ve->id_vehiculo; ?>">
                                <?php echo $ve->chapa_nro . " - " . $ve->marca ?></option>
                            <?php endforeach;
                            ?>
                          </select>
                        </div>
                  ...
                  <div class="checkbox">
                    <label>
                      ...
                      <input type="hidden" name="id_sucursal" id="id_sucursal"
                        value="<?php echo $sucursales->id_sucursal; ?>">
                      <a href="index.php?action=eliminarcompraproductos3&id_sucursal=<?php echo $sucursales->id_sucursal; ?>"
                        class="btn btn-lg btn-danger"><i class="glyphicon glyphicon-remove"></i> Cancelar</a>
                      <button id="accion" class="btn btn-lg btn-warning" onclick="accion()"><b></b> Finalizar
                        Remision</button></label>
