                        ...
                        foreach ($cotizacion as $moneda) {
                          ...
                          <?php foreach ($mon as $mo): ?>
                            ...
                            <td style="width:80px;">
                              ...
                              <a href="index.php?action=eleminarcotizacion&id_sucursal=<?php echo $sucursales->id_sucursal; ?>&id_cotizacion=<?php echo $moneda->id_cotizacion; ?>"
                                class="btn btn-danger btn-sm btn-flat" title="Eliminar"><i class='fa fa-trash'></i></a>
                            </td>
                          </tr>
                          <?php
                        }
        ...
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title"><i class="fa fa-steam-square" style="color: orange;"></i><b style="color: black;">
                Registrar Cotización del día</b></h4>
          </div>
          <div class="modal-body">
            <form class="form-horizontal" action="index.php?action=nuevacotizacion" role="form" method="post"
                ...
                <div class="col-sm-9">
                  ...
                  <select required="" name="id_tipomoneda" id="id_tipomoneda" class="form-control">
                    ...
                    <?php foreach ($monedas as $money): ?>
                      ...
                      $valocito = null;
                      ?>
                      <option value="<?php echo $money->id_tipomoneda; ?>">
                        <?php echo $money->nombre . "-" . $money->simbolo; ?>
                      </option>
              ...
              <div class="form-group has-feedback has-warning">
                ...
                <div class="col-sm-9">
                  <input type="date" class="form-control" id="fecha_cotizacion" name="fecha_cotizacion" required
                    value="<?php echo $fecha; ?>" <?php echo $fecha; ?>>
