               ...
               <div class="panel-body">
				 ...
				 <div class="form-group has-feedback has-warning">
                        ...
                        if (count($categories) > 0) : ?>
                         <select name="id_grupo" id="id_grupo" required class="form-control">
                           ...
                           <?php foreach ($categories as $cat) : ?>
                             <option value="<?php echo $cat->id_grupo; ?>" style="color: orange;"><i class="fa fa-gg"></i><?php echo $cat->nombre_grupo; ?></option>
                           <?php endforeach; ?>
                         </select>
                       <?php else :
                        ...
                        if (count($Marcas) > 0) : ?>
                         <select name="marca_id" id="marca_id" required class="form-control">
                           ...
                           <?php foreach ($Marcas as $marca) : ?>
                             <option value="<?php echo $marca->id_marca; ?>" style="color: orange;"><i class="fa fa-gg"></i><?php echo $marca->nombre; ?></option>
                           <?php endforeach; ?>
                         </select>
                       <?php endif; ?>
                     </div>
                        ...
                        if (count($Tipoprod) > 0) : ?>
                         <select name="tipo_producto" id="tipo_producto" required class="form-control">
                           ...
                           <?php foreach ($Tipoprod as $Tipoprods) : ?>
                             <option value="<?php echo $Tipoprods->TIPO_PRODUCTO; ?>" style="color: orange;"><i class="fa fa-gg"></i><?php echo $Tipoprods->TIPO_PRODUCTO; ?></option>
                           <?php endforeach; ?>
                         </select>
                       <?php endif; ?>
                     </div>
                   ...
                   <div class="form-group has-feedback has-warning">
                     ...
                     <div class="col-lg-4">
                       <input type="text" name="q" class="form-control" id="q" placeholder="Cantidad del Producto" onkeypress="return solonumeross(event)">
                       <span class="fa fa-sort-amount-desc form-control-feedback"></span>
                     </div>
                     <label class="col-lg-2 control-label">Stock Mínimo:</label>
                     <div class="col-lg-4">
                       <input type="text" name="inventario_minimo" class="form-control" id="inventario_minimo" onkeypress="return solonumeross(event);" placeholder="Stock minimo" maxlength="800">
                       <span class="fa fa-sort-amount-desc form-control-feedback"></span>
                     </div>

                     <label class="col-lg-2 control-label">Stock Máximo:</label>
                     <div class="col-lg-4">
                       <input type="text" name="inventario_maximo" class="form-control" id="inventario_maximo" onkeypress="return solonumeross(event);" placeholder="Stock máximo" maxlength="800">
                       <span class="fa fa-sort-amount-desc form-control-feedback"></span>
                     </div>
                   ...
                   <div class="form-group has-feedback has-warning">
                     ...
                     <div class="col-lg-4">
                       <input type="text" name="precio_compra" class="form-control" id="precio_compra" placeholder="Precio de Compra" maxlength="800">
                       <span class="fa fa-dollar form-control-feedback"></span>
                     </div>
                     <label class="col-lg-2 control-label" hidden>Precio Venta:</label>
                     <div class="col-lg-4" hidden>
                       <input type="text" value="0" name="precio_venta" id="precio_venta" class="form-control" placeholder="Precio de Venta" oninput="operacion()" required="">
                       <span class="fa fa-dollar form-control-feedback"></span>
                     </div>
                   ...
                   <div class="form-group has-feedback has-warning">
                     ...
                     <div class="col-lg-4">
                       <input type="text" name="codigo_nivel_especifico" id="codigo_nivel_especifico" class="form-control">
                     </div>
