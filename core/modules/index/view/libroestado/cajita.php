                        ...
                        <div class="box">
                            ...
                            <div class="row">
                                <?php if (isset($_GET["sd"])) {
                                    ?>
                                    <button style="margin-left: 30px;" onclick="exportar2()" href=""
                                        class="mx-4 my-2 btn btn-success">EXCEL</button>
                                    ...
                                    <h1 style="margin-left: 30px;">Estadode cuentas desde <?php echo $date1 ?> al
                                        <?php echo $date2 ?></h1>
