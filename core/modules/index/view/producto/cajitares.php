              ...
              <div class="box">
               ...
               <a href="#addnew" data-toggle="modal" class="btn btn-warning btn-sm btn-flat"><i class="fa fa-cart-plus"></i> Nuevo Producto</a>
                ...
                <div class="box-body">
                  <div class="table-responsive">
                    <?php
                    $productos = ProductoData::verproductosucursal($sucursales->id_sucursal);
                    if (count($productos) > 0) {
                      // si hay Productos
                    ?>
                      <table id="example1" class="table table-bordered table-dark" style="text-align:center">
                        <thead>
                          ...
                          <th>
                            <center>Prec. Compra</center>
                          </th>
                          <!-- <th>
                            <center>Prec. Venta</center>
                          </th> -->
                          <th>
                        ...
                        <tbody>
                          ...
                          ?>
                            <tr>
                              <td width="80px"><?php echo $producto->codigo; ?></td>
                              <td width="100px"><?php echo $producto->nombre; ?></td>
                              <td width="80px">
                                <center><a class="fancybox" href="<?php echo $url; ?>" target="_blank" data-fancybox-group="gallery" title="Smartphone Samsung Galaxy"><img class="fancyResponsive img-circle" src="<?php echo $url; ?>" alt="" width="30" height="30" /></a></center>
                              </td>

                              <td width="110px"> <b> <?php echo  number_format($producto->precio_compra, 2, ',', '.'); ?></b></td>


                              <!-- <td><?php echo $producto->precio_venta; ?></td> -->

                              <td width="40px"><?php if ($producto->activo == 1) : ?>
                                  <i class="fa fa-check"></i>
                                <?php else : ?>
                                  <i class="fa fa-close"></i>
                                <?php endif ?>
                              ...
                              <td style="width:150px;">
                                <a href="index.php?view=actualizarproducto1&id_sucursal=<?php echo $sucursales->id_sucursal; ?>&id_producto=<?php echo $producto->id_producto; ?>" data-toggle="modal" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-cog"></i> Editar</a>
                                <a href="index.php?action=eliminarproducto1&id_sucursal=<?php echo $sucursales->id_sucursal; ?>&id_producto=<?php echo $producto->id_producto; ?>" class="btn btn-danger btn-sm btn-flat"><i class='fa fa-trash'></i> Eliminar</a>
                              </td>
                            </tr>
                        <?php
                          }
