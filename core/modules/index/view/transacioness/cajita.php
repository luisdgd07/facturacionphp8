                      ...
                      <tbody>
                        ...
                        foreach ($users as $user) {
                          ...
                          <tr>
                            ...
                            <td><?php echo UnidadesData::getById($user->presentacion)->nombre; ?></td>
                    ...
                    <table id="example1" class="table table-bordered table-dark" style="width:100%">
                      ...
                      <tbody>
                        ...
                        foreach ($products as $sell) {
                          $producto = $sell->producto_id;
                          $q1 = OperationData::getQYesFf($sell->producto_id);
                          $fila = $sell->is_sqlserver ? "id_sqlserver" : "id_producto";
                          $pro = ProductoData::getById($producto, $fila);
                          ?>

                          <tr>
                            <td><?php echo $pro->codigo; ?></td>
                            <td><?php echo $pro->nombre; ?></td>
                            <td><?php echo number_format($pro->precio_compra, 2, ',', '.'); ?></td>
                            <td><?php echo number_format($pro->precio_venta, 2, ',', '.'); ?></td>
