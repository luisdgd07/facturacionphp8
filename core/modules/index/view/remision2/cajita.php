            ...
            success: function (dataResult) {
                ...
                for (const [key, venta] of Object.entries(result.data.venta)) {
                    tablab +=
                        `<tr>
                            <td>
                                ...
                                <a 
                                href="index.php?view=detalleventaproductoremision&id_venta=${venta.id}" 
                    ...
                    tablab +=
                        `</td>
                        <td >
                            <button onclick="editarPlacas(${venta.id})" class="btn btn-danger btn-sm btn-flat">Editar </button></abbr>
                        </td>
                        <tr>    
                        `;
                }
