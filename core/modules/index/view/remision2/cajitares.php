                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <?php if ($sell->enviado == "Cancelado" || $sell->enviado == "Aprobado" || $sell->enviado == "Rechazado") {
                            ...
                            $productosItem  = array();
                            // var_dump($operations);
                            $tipo = ProductoData::verinsumo($_GET['id_sucursal']);
                            ...
                            <button class="btn btn-success" onclick='genKude(<?php echo json_encode($productosItem) ?>,
                                                                    {
                                                                        ...
                                                                        correo:"<?php echo $client->email; ?>",
                                                                        vipoVenta: 2,
                                                                        cdcAsociado:"<?php echo $venta->cdc_fact; ?>",
                                                                        venta:"<?php echo $remi->factura; ?>",
                                                                        tipoFactura: "Remisión",
                                                                        operacion: "Remisión Electrónica",
                                                                        chofer:"<?php echo $chofer->nombre ?>",
                                                                        razonchofer:"<?php echo $chofer->nombre ?>",
                                                                        respon:"<?php if ($sucursalDatos->id_sucursal == 19) {
                                                                                  $u = UserData::getById($venta->usuario_id);
                                                                                  echo $u->nombre . " " . $u->apellido;
                                                                                } else {
                                                                                  echo $u->nombre . " " . $u->apellido;
                                                                                } ?>",
                                                                        marca:"<?php echo $vehiculo->marca ?>",
                                                                        razonchofer:"<?php echo $chofer->nombre ?>",
                                                                        dirchofer:"<?php echo $chofer->direccion ?>",
                                                                        rucchofer:"<?php echo $chofer->cedula ?>",
                                                                        inicio: "<?php echo $venta->fecha_envio ?>",
                                                                        fin:"<?php echo $venta->fecha_envio ?>",
                                                                        fintras:"<?php echo $venta->fecha_envio ?>",
                                                                        iniciotras:"<?php echo $venta->fecha_envio ?>",
                                                                        casasalida: "",
                                                                        casaentrega: "",
                                                                        chapa:"<?php echo $vehiculo->chapa_nro ?>",
                                                                        kms: "0",
                                                                        rua:"<?php echo $vehiculo->rua_nro ?>",
                                                                        tipo_transporte:<?php echo $venta->tipo_transporte ?>,
                                                                        motivo:<?php echo $venta->tipo_remision ?>,
                                                                        ident: "",
                                                                        transpor: "",
                                                                        idtrans: "",
                                                                        kudeQr:"<?php echo $venta->kude; ?>",
                                                                        numChofer:"<?php echo $chofer->telefono ?>",
                                                                        <?php if ($sucursalDatos->id_sucursal == 19) {
                                                                        ?>
                                                                        puntoLlegada:"<?php echo $venta->destino ?>",
                                                                        envioCorreo:true
                                                                            <?php  } ?>
                                                                    },<?php echo json_encode($p) ?>)'>Enviar</button>
                        ...
                        <td>
                          ...
                          <?php if ($sell->enviado == "Aprobado" || $sell->enviado == "Cancelado" || $sell->enviado == "Rechazado") {
                            $venta = VentaData::getById($sell->id_venta);
                            $telefonoEmisor =  $venta->verSocursal()->telefono;
                            $rucEmisor = $venta->verSocursal()->ruc;
                            $direccionCliente = $venta->getCliente()->direccion;
                            ...
                            $fletera = "";
                            if ($sell->fletera_id) {
                              $flet = FleteraData::VerId($sell->fletera_id);
                              $fletera = $flet->nombre_empresa;
                            }
                          ?>
                            ...
                            <button class="btn btn-success" onclick='genKude(<?php echo json_encode($productosItem) ?>,
                                                                    {
                                                                        ...
                                                                        puntoLlegada:"<?php echo $venta->destino ?>",
                                                                            <?php  } ?>
                                                                    },<?php echo json_encode($p) ?>)'>Descargar</button>
...
<script>
  ...
  function kudedescargar(items, cdc, factura, fecha, condicion, rucCliente, cambio, cliente, moneda, direccion, telefono, iva10, iva5, tipo, email, tiporemi, usuario, marca, chapa, chofer, dircho, cicho, placas, motivo, tipo_transporte, puntoLlegada, fletera, numChofer, rua) {
    ...
    // 
    let flete = '<?php echo $sucursalDatos->razon_social ?>';
    let transpor2 = '<?php echo $sucursalDatos->razon_social ?>';
    let chofer2 = chofer;
