    ...
    <?php if ($u->is_empleado) : ?>
        ...
        <div class="content-wrapper">
            ...
            <script>
                ...
                function kudedescargar(items, cdc, factura, fecha, condicion, rucCliente, cambio, cliente, moneda, direccion, telefono, iva10, iva5, tipo, email, cdcA, pais, fletera, agente, peson, pesob, cdcAsociado, embarque, remision) {
                    console.log(cdcA)
                    Swal.fire({
