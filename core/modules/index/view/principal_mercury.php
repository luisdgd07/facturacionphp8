                  ...
                  <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="treeview">
                      ...
                      <ul class="treeview-menu">
                        ...
                        <li><a href="index.php?view=vender2&id_sucursal=<?php echo $sucursal->id_sucursal; ?>"><i class="fa fa-money" style="color: orange;"></i> Realizar Venta Directa</a></li>
						
						<li><a href="index.php?view=vender&id_sucursal=<?php echo $sucursal->id_sucursal; ?>"><i class="fa fa-money" style="color: orange;"></i> Realizar Venta Contrato</a></li>
