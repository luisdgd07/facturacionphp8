                                                                ...
                                                                if ($sell->enviado == "Aprobado") {
                                                                    ...
                                                                    foreach ($operations as $operation) {
                                                                        ...
                                                                        $array = [
                                                                            ...
                                                                            "observacion" => "",
                                                                            "unidadMedida" => $product->presentacion,
                                                                            "cantidad" => $cant,
                                                                            "cambio" => "0",
                                                                            "ivaTipo" => 1,
                                                                            "ivaBase" => "100",
...
<script>
    ...
    // function kude(items, cdc, factura, fecha, condicion, rucCliente, cambio, cliente, moneda, direccion, telefono, iva10, iva5, tipo, email) {
    //     console.log(items)
            ...
            success: function(dataResult) {
                ...
                try {
                    ...
                    if (lotesenviados.length == undefined) {
                        ...
                        console.log("aqui3");
                        for (let i = 0; i < script lotesenviados.length; i++) {
                            console.log('ss ');
                            dataEnviada.push({
                                venta: ventas[i],
