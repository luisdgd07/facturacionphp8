...
<body id="cuerpoPagina">
  <div class="zona_impresion">
    ...
    $total = 0;
    $moneda = 'PYG';
    $ventas = VentaData::getByIdRemision($_GET["id_venta"]);
            ...
            <?php if (isset($_GET["id_venta"]) && $_GET["id_venta"] != ""): ?>
              ...
              <div class="box">
                <div class="box-body">
                  ...
                  <div class="row">
                    <!-- <div class="col-lg-3">
                      <a target="_BLANK" href="impresionticket.php?id_venta=<?php echo $_GET["id_venta"] ?>" class="btn btn-primary btn-sm btn-flat"><i class='fa fa-file-code-o' style="color: orange"></i> IMPRIMIR TICKET</a>
                    </div>
                    <div class="col-lg-3">
                      <a target="_BLANK" href="impresionremision.php?id_venta=<?php echo $_GET["id_venta"] ?>" class="btn btn-primary btn-sm btn-flat"><i class='fa fa-file-code-o' style="color: orange"></i> IMPRIMIR REMISION</a>
                    </div> -->
                    <br>
