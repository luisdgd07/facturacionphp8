                ...
                <?php } else { ?>
                  ...
                  <div class="col-md-4">
                    ...
                    <div class="box-body">
                      ...
                      <div class="form-group">
                        <h3 class="">Documentos <?php
                                                $cliente = ClienteData::getById($_GET['cliente_id']);
                                                echo $cliente->id_precio == 46 ? 'PERSONA FISICA' : 'PERSONA JURIDICA';
                                                ?> </h3>
                  ...
                  <div class="col-md-2">
                    ...
                    <div class="box-body">
                      ...
                      <div class="form-group">
                        <div class="">
                          <input type="text" class="form-control" value="<?php echo $data ? $data['contrato_cliente'] : '' ?>" name="contrato_cliente_ob" autocomplete="off">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="">
                          <input type="date" class="form-control" required  value="<?php echo $data['fecha'] ?>" name="fecha" autocomplete="off"  >
                        </div>
                      </div>
                    </div>
                  ...
                  ?>
                    <div class="col-md-2">
                      ...
                      <div class="box-body">
                        ...
                        <div class="form-group" style="height: 35px;">
                          <?php if ($data3['form_identificacion'] != '') { ?>
                            <div class="">
                        ...
                        <div class="form-group" style="height: 35px;">
                          <?php if ($data3['escri_constitucion'] != '') { ?>
                            <div class="">
                        ...
                        <div class="form-group" style="height: 35px;">
                          <?php if ($data3['consulta_lista_peps'] != '') { ?>
                            <div class="">
                        ...
                        <div class="form-group" style="height: 35px;">
                          <?php if ($data3['consulta_list_ofac'] != '') { ?>
                            <div class="">
                        ...
                        <div class="form-group" style="height: 35px;">
                          <?php if ($data3['total_doc_presentar'] != '') { ?>
                            <div class="">
                        ...
                        <div class="form-group" style="height: 35px;">
                          <?php if ($data3['total_doc_presentado'] != '') { ?>
                            <div class="">
                  ...
                  <div class="box-footer">
                    <div class="form-group">
                      <div class="col-sm-offset-2 col-sm-10">
                        ...
                        <button onclick="window.location.reload()" class="btn btn-default btn-reset">Cancelar</button>
                      </div>
                    </div>
                  </div>
