...
class UserData
{
	...
	public function __construct(
		...
		public int $is_empleado = 0,
		public int $is_mozo = 0,
		public int $is_activo = 1,
		public int $is_publico = 0,
		public int $is_cheff = 0,
		public int $is_ayudante = 0,
		public int $is_cocinero = 0,
		public int $is_panadero = 0,
		public int $is_confitero = 0,
		public int $is_barman = 0,
		public int $is_personal_limpieza = 0,
		public int $is_cajero = 0,
