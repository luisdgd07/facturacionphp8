...
class ProductoData
{
	...
	{
		$sql = "select * from " . self::$tablename . " where categoria_id=$idcate";
		$query = Executor::doit($sql);
		return Model::many($query[0], new ProductoData());
	}
	...
	public static function getByContrato($id_producto)
	{
		$sql = "select * from " . self::$tablename . " where contrato_id=$id_producto";
		$query = Executor::doit($sql);
		return Model::many($query[0], new ProductoData());
	}
	...
	public static function verproductos($id_sucursal)
	{
		$sql = "select * from " . self::$tablename . " where sucursal_id=$id_sucursal";
		$query = Executor::doit($sql);
		return Model::many($query[0], new ProductoData());
