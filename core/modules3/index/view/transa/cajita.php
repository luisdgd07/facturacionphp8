                                ...
                                <tr>
                                  ...
                                  <td style="width:30px;">
                                    <?php if ($sell->accion_id != 3) { ?>
                                      <abbr> <button onclick="anular2(<?php echo $sucursales->id_sucursal; ?>,<?php echo $sell->id_venta; ?>,<?php echo $sell->accion_id ?>,<?php echo $operations[$p]->id_proceso ?>,<?php echo $operations[$p]->producto_id ?>,<?php echo $operations[$p]->deposito ?>,<?php echo $operations[$p]->q; ?>)" class="btn btn-danger btn-sm btn-flat"><i class='fa fa-trash'></i> </button></abbr>
                                    <?php } ?>
                                  </td>
                                  <td style="width:30px;">
