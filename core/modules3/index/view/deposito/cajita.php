        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body">
              <div class="table-responsive">
             <?php
                $categorias = ProductoData::verdeposito($sucursales->id_sucursal);
                if(count($categorias)>0){
                  // si hay categorias
                  ?>
              <table id="example1" class="table table-bordered table-dark" style="width:100%">
                ...
                <tbody>
                  ...
                  <td><?php echo $categoria->NOMBRE_DEPOSITO; ?></td>
                  <td style="width:150px;">
                    <a href="index.php?view=actualizardeposito&id_sucursal=<?php echo $sucursales->id_sucursal;?>&id_deposito=<?php echo $categoria->DEPOSITO_ID;?>" data-toggle="modal" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-cog"></i> Editar</a>
                  ...
                  echo "<p class='alert alert-danger'>No hay depósitos registrados</p>";
                }
                ?>
                </tbody>
              </table>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
              <h4 class="modal-title"><i class="fa fa-steam-square" style="color: orange;"></i><b style="color: black;"> Agregar Nuevo Depósito</b></h4>
            </div>
            <div class="modal-body">
              <form class="form-horizontal" action="index.php?action=nuevodeposito" role="form" method="post" enctype="multipart/form-data">
               
                <div class="form-group has-feedback has-warning">
                    <label for="inputEmail1" class="col-sm-3 control-label">Descripción</label>
                    <div class="col-sm-9">
                      <textarea class="form-control" id="descripcion" name="descripcion" placeholder="Descripcion del depósito"></textarea>
                      <span class="fa fa-file-text form-control-feedback"></span>
                    </div>
                </div>
            </div>
