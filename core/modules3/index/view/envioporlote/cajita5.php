...
<script>
    ...
    function enviar() {
        ...
        $.ajax({
            // url: "https://facturacionelectronica-production.up.railway.app/enviarlote",
        ...
        $.ajax({
            ...
            success: function(dataResult) {
                ...
                try {
                    ...
                    let textoLote = "";
                    lotesenviados = lotes['ns2:rResEnviConsLoteDe']['ns2:gResProcLote'] + " " + lotesenviados[i]["ns2:gResProc"]["ns2:dMsgRes"];
                    if (lotesenviados.length == undefined) {
                        ...
                        textoLote += lotesenviados["ns2:dEstRes"] + " " + lotesenviados["ns2:gResProc"]["ns2:dMsgRes"];
                    } else {
                        console.log("aqui3");
                        for (let i = 0; i < lotesenviados.length; i++) {
                            ...
                            textoLote += lotesenviados[i]["ns2:dEstRes"] + " " + lotesenviados[i]["ns2:gResProc"]["ns2:dMsgRes"]
                            "\n"
                        }
                    }
    ...
    function consultaLote(lote) {
        let cert = './facturacionElectronica<?php echo $sucursalDatos->certificado_url ?>';
        $.ajax({
            url: "https://facturacionelectronica-production.up.railway.app/consultalote",
            // url: "http://18.208.224.72:3000/consultalote",
            // url: "http://18.208.224.72:3000/consultaruc",
            // url: "http://localhost:3000/consultalote",
            type: "POST",
