            ...
            <form class="form-horizontal" enctype="multipart/form-data" method="post" action="index.php?action=actualizarcliente" role="form">
              ...
              <div class="form-group">
                <div class="col-lg-offset-2 col-lg-2">
                  <div class="checkbox">
                    <label>
                      <input type="checkbox" name="is_publico" <?php if ($cliente->is_publico) {
                                                                  echo "checked";
                                                                } ?>> Público
                    </label>
                  </div>
                ...
                <!-- <div class="col-lg-2">
                        <div class="checkbox">
                          <label>
                            <input type="checkbox" name="is_admin" <?php if ($cliente->is_admin) {
                                                                      echo "checked";
                                                                    } ?>> Admin
                          </label>
                        </div>
                ...
                <div class="col-lg-2">
                  <div class="checkbox">
                    <label>
                      <input type="checkbox" name="is_proveedor" <?php if ($cliente->is_proveedor) {
                                                                    echo "checked";
                                                                  } ?>> Proveedor
                    </label>
                  </div>
