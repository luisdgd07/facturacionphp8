   ...
   <div class="content-wrapper">
               ...
               <div class="box box-warning">
                 <div class="panel-body form-horizontal">
                   ...
                   <div class="form-group has-feedback has-warning">
                     ...
                     <div class="col-sm-9">
                       <input type="text" class="form-control" id="nombre" name="nombre" required maxlength="80" value="<?php echo $cliente->nombre ?>">
                       <span class="fa fa-file-text form-control-feedback"></span>
                     </div>

                     <label for="inputEmail1" class="col-sm-3 control-label">Ruc:</label>
                     <div class="col-sm-9">
                       <input type="text" class="form-control" id="ruc" name="ruc" required maxlength="80" value="<?php echo $cliente->ruc ?>">
                       <span class="fa fa-file-text form-control-feedback"></span>
                     </div>
                   </div>
                   <div class="form-group has-feedback has-warning">
                     ...
                     <div class="col-sm-3">
                       <input type="text" class="form-control" id="telefono" name="telefono" maxlength="500" value="<?php echo $cliente->telefono ?>" placeholder="telefono">
                       <span class="fa fa-steam form-control-feedback"></span>
                     </div>
                     <label for="inputEmail1" class="col-sm-2 control-label">Representante:</label>
                     <div class="col-sm-4">
                       <input type="text" class="form-control" id="representante" name="representante" maxlength="500" value="<?php echo $cliente->representante ?>" placeholder="Representante">
                       <span class="fa fa-steam form-control-feedback"></span>
                     </div>
                   </div>
                   <div class="form-group has-feedback has-warning">
                     ...
                     <div class="col-sm-9">
                       <input type="text" class="form-control" id="direccion" name="direccion" required maxlength="80" value="<?php echo $cliente->direccion ?>">
                       <span class="fa fa-file-text form-control-feedback"></span>
                     </div>
                   </div>
                   ...
                   <div class="form-group has-feedback has-warning">
                     ...
                     <div class="col-sm-9">
                       <input type="text" class="form-control" id="numero_casa" name="numero_casa" required maxlength="160" value="<?php echo $cliente->numero_casa ?>">
                       <span class="fa fa-file-text form-control-feedback"></span>
                     </div>
                   </div>
                   <div class="form-group has-feedback has-warning">
                     ...
                     <div class="col-sm-9">
                       <input type="file" class="form-control" id="certificado" required maxlength="80" value="<?php echo $cliente->descripcion ?>">
                       <span class="fa fa-file-text form-control-feedback"></span>
                       <button class="btn btn-primary" onclick="subirCert()" style="margin-top: 20px;">Subir certificado</button>
                   ...
                   <div class="form-group has-feedback has-warning">
                     ...
                     <div class="col-sm-9">
                       <input type="file" class="form-control" id="logo" required maxlength="80" value="<?php echo $cliente->clave ?>">
                       <span class="fa fa-file-text form-control-feedback"></span>
                   ...
                   <div class="form-group has-feedback has-warning">
                     ...
                     <div class="col-sm-9">
                       <input type="text" class="form-control" id="clave" name="clave" required maxlength="160" value="<?php echo $cliente->clave ?>">
                       <span class="fa fa-file-text form-control-feedback"></span>
                     </div>
                   </div>
                   <div class="form-group has-feedback has-warning">
                     ...
                     <div class="col-sm-9">
                       <input type="date" class="form-control" id="fecha_firma" name="fecha_firma" required maxlength="160" value="<?php echo $cliente->fecha_firma ?>">
                       <span class="fa fa-file-text form-control-feedback"></span>
                     </div>
                   </div>
                   <div class="form-group has-feedback has-warning">
                     ...
                     <div class="col-sm-9">
                       <input type="date" class="form-control" id="fecha_tim" name="fecha_tim" required maxlength="160" value="<?php echo $cliente->fecha_tim ?>">
                       <span class="fa fa-file-text form-control-feedback"></span>
                     </div>
                   </div>
                   <div class="form-group has-feedback has-warning">
                     ...
                     <div class="col-sm-9">
                       <input type="razon_social" class="form-control" id="razon_social" name="razon_social" required maxlength="160" value="<?php echo $cliente->razon_social ?>">
                       <span class="fa fa-file-text form-control-feedback"></span>
                     </div>
                   </div>
                   <div class="form-group has-feedback has-warning">
                     ...
                     <div class="col-sm-9">
                       <input type="razon_social" class="form-control" id="nombre_fantasia" name="nombre_fantasia" required maxlength="160" value="<?php echo $cliente->nombre_fantasia ?>">
                       <span class="fa fa-file-text form-control-feedback"></span>
                     </div>
                   </div>
                   <div class="form-group has-feedback has-warning">
                     ...
                     <div class="col-sm-9">
                       <input type="number" class="form-control" id="establecimiento" name="establecimiento" required maxlength="160" value="<?php echo $cliente->establecimiento ?>">
                       <span class="fa fa-file-text form-control-feedback"></span>
                     </div>
                   </div>
                   <div class="form-group has-feedback has-warning">
                     ...
                     <div class="col-sm-9">
                       <input type="text" class="form-control" id="timbrado" name="timbrado" required maxlength="150" value="<?php echo $cliente->timbrado   ?>">
                       <span class="fa fa-file-text form-control-feedback"></span>
                     </div>
                   </div>
                   <div class="form-group has-feedback has-warning">
                     ...
                     <div class="col-sm-9">
                       <input type="text" class="form-control" id="codigo_act" name="codigo_act" required maxlength="80" value="<?php echo $cliente->codigo_act  ?>">
                       <span class="fa fa-file-text form-control-feedback"></span>
                     </div>
                   </div>
                   <div class="form-group has-feedback has-warning">
                     ...
                     <div class="col-sm-9">
                       <input type="text" class="form-control" id="actividad" name="actividad" required maxlength="80" value="<?php echo $cliente->actividad ?>">
                       <span class="fa fa-file-text form-control-feedback"></span>
                     </div>
                   </div>
                   <div class="form-group has-feedback has-warning">
                     ...
                     <div class="col-sm-9">
                       <input type="text" class="form-control" id="com_dir" name="com_dir" required maxlength="80" value="<?php echo $cliente->com_dir ?>">
                       <span class="fa fa-file-text form-control-feedback"></span>
                     </div>
                   </div>
                   <div class="form-group has-feedback has-warning">
                     <label for="inputEmail1" class="col-sm-3 control-label">Complemento Direccion:</label>
                     <div class="col-sm-9">
                       <input type="text" class="form-control" id="com_dir2" name="com_dir2" required maxlength="80" value="<?php echo $cliente->com_dir2 ?>">
                       <span class="fa fa-file-text form-control-feedback"></span>
                     </div>
                   </div>
                   <div class="form-group has-feedback has-warning">
                     ...
                     <div class="col-sm-9">
                       <input type="text" class="form-control" id="email" name="email" required maxlength="80" value="<?php echo $cliente->email ?>">
                       <span class="fa fa-file-text form-control-feedback"></span>
                     </div>
                   </div>
                   <div class="form-group has-feedback has-warning">
                 ...
                 <div class="modal-footer">
                   ...
                   <button onclick="actualizar()" class="btn btn-warning btn-flat" name="add"><i class="fa fa-save"></i> Guardar</button>
                   <!-- </form> -->
                 </div>
               </div>
             </div>
     ...
     <script>
       ...
       function subirCert() {
         ...
         $.ajax({
           //  url: "<?php echo $GLOBALS['URL'] ?>/subircert",
