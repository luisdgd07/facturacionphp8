                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td><a href="index.php?view=vender&id_sucursal=<?php echo $_GET["id_sucursal"]; ?>&tid=<?= $sell->id_venta; ?>" class="btn btn-xs btn-default"><i class="fa fa-share" style="color: orange;"></i></a></td>
                      </tr>
                  <?php
                    }
                  } else {
