                            ...
                            <div class="col-md-12">
                                ...
                                ?>
                                    ...
                                    ?>
                                        ...
                                        $opertAnte = OperationData::getByProductoId4($_GET['id_sucursal'], $op->id_producto, '1988-01-09', $n);
    ...
    <script>
        <?php if (isset($_GET['sd'])) { ?>
            ...
            function exportar() {
                ...
                window.open(`pdfs/operaciones.php?sd=<?php echo $_GET['sd'] ?>&ed=<?php echo $_GET['ed'] ?>&id_sucursal=<?php echo $_GET['id_sucursal'] ?>&categoria=<?php echo $_GET['categoria'] ?>&producto=<?php echo $_GET['producto'] ?>`);
            ...
            function exportar2() {
                ...
                window.open(`  csvproductos.php?sd=<?php echo $_GET['sd'] ?>&ed=<?php echo $_GET['ed'] ?>&id_sucursal=<?php echo $_GET['id_sucursal'] ?>&categoria=<?php echo $_GET['categoria'] ?>&producto=<?php echo $_GET['producto'] ?>`);
        ...
        function ver() {
            date1 = document.getElementById("date1").value;
            date2 = document.getElementById("date2").value;
            window.location.href = `index.php?view=reportestockproductos&sd=${date1}&ed=${date2}&id_sucursal=<?php echo $_GET['id_sucursal'] ?>&categoria=${$('#categoria').val()}&producto=${$('#products').val()}`
        }
