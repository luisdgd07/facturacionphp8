            ...
            <div class="box-body">
              <?php
                ...
                <table class="table table-bordered table-hover  ">
                  ...
                  <tr>
                    <td style="width:30px;">
                    <a href="index.php?view=detalleventaproductomasivo&id_venta=<?php echo $sell->id_venta; ?>" class="btn btn-xs btn-default"><i class="glyphicon glyphicon-eye-open" style="color: orange;"></i></a></td>
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            <div class="box-body">
              <?php
                $products = VentaData::versucursaltipoventas_masiva($sucursales->id_sucursal);
                ...
                <table id="example1" class="table table-bordered table-hover  ">
                  ...
                  <tr>    
                   <?php
                    ...
                    <td style="width:30px;">
                    <a href="index.php?view=detalleventaproductomasivo&id_sucursal=<?php echo $sucursales->id_sucursal;?>&id_venta=<?php echo $sell->id_venta; ?>" class="btn btn-xs btn-default"><i class="glyphicon glyphicon-eye-open" style="color: orange;"></i></a></td>
                  ...
                  <td>
                    ...
                    <!-- <td><?php echo $sell->formapago ?></td> -->
						...
						<td class="">
                     <?php if ($sell->VerTipoModena()->simbolo=="US$") {echo  $sell->cambio2;
