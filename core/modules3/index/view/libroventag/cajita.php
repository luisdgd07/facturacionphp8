            ...
            <div class="content-wrapper">
                ...
                <script>
                    ...
                    function exportar3() {
                        ...
                        window.location.href = `index.php?view=libroventag&uso_id=&sd=${date1}&ed=${date2}&id_sucursal=${id_sucursal}&prod=${product}&producto=${producto}&venta=${v}&cliente=${cliente}`;
