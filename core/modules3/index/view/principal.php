                  ...
                  <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="treeview">
                      ...
                      <ul class="treeview-menu">
                        ...
                        <li><a href="index.php?view=reporteventa&id_sucursal=<?php echo $sucursal->id_sucursal; ?>"><i class="fa fa-bar-chart-o" style="color: orange;"></i> Gráfico de ventas de productos</a></i></li>
