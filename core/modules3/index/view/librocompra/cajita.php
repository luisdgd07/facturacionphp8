                ...
                <section class="content">
                    ...
                    <div class="col-xs-12">
                        <div class="box">
                            ...
                            <button onclick="exportar()" href="" class="mx-4 my-2 btn btn-success">Exportar Libro compras</button>
                            <script>
                                function exportar() {
                                    date1 = document.getElementById("date1").value;
                                    date2 = document.getElementById("date2").value;
                                    id_sucursal = document.getElementById("id_sucursal").value;
                                    window.location.href = `excels/csvVenta2.php?&uso_id=&sd=${date1}&ed=${date2}&id_sucursal=${id_sucursal}`;
                                }
                            </script>
                        </div>
                    </div>
