      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            <div class="box-body">
              <?php
              $boxes = CajaData::vercajaporusuario($usuarios->id_usuario);
              ...
              ?>
                <div class="jumbotron">
                  ...
                  <p>Usted señor <b><?php echo $usuarios->nombre." ".$usuarios->apellido; ?></b>, aun no ha realizado Ningu Cierre de Caja.</p>
                </div>
