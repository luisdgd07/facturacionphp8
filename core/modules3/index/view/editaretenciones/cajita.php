                          ...
                          <div class="box">
                              <form action="index.php?action=editaretencion" method="post">
                                  <div class="">
                                      ...
                                      <div class="col-lg-2">
                                          <input type="date" class="form-control" name="fecha" id="cantidadPl" value="<?php echo $r->fecha ?>">

                                      </div>
                                      <input hidden style="display: none" class="form-control" name="id" id="cantidadPl" value="<?php echo $_GET['id'] ?>">
                                      <input hidden style="display: none" class="form-control" name="id_sucursal" id="cantidadPl" value="<?php echo $_GET['id_sucursal'] ?>">
                                  </div>
                                  ...
                                  <div class="form-group">
                                      <div class="col-lg-offset-2">
                                          <label>
                                              ...
                                              <button id="accion" type="submit" class="btn btn-lg btn-success"><b></b>Editar</button></label>
                                          <br>
