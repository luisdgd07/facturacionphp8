                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="box">
                            <div class="box-body">
                                <?php
                                $products = VentaData::getnota_credito();
            ...
            <section class="content">
                <div class="row">
                    <div class="col-xs-12">
                        <div class="box">
                            <br>
                            <button onclick="enviar()" class="btn btn-primary">Enviar a Nota de Crédito a Sifén</button>
                            <br>
                            <div class="box-body">
                                <?php
            ...
            success: function(dataResult) {
                ...
                try {
                    ...
                    Swal.fire({
                        ...
                        text: `El lote ${lote} esta en procesamiento, espere en 30 segundos automaticamente se volvera a realizar la consulta`,
                        icon: 'error',
                        confirmButtonColor: '#ff0000',
                        confirmButtonText: 'Recargar pagina'
                    }).then((result) => {
