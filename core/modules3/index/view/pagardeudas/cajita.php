      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body">
              <form class="form-horizontal" action="index.php?action=nuevopagare" role="form" method="post" enctype="multipart/form-data">
                <div class="form-group">
                  <?php
                    ...
                    <div class="col-lg-2">
                      <input type="number" required="" max="<?php echo $ventas->total; ?>" name="cash" value="<?php echo $ventas->total-$ventas->cash; ?>" class="form-control">
                    </div>
                    <div class="col-lg-1">
                      <div class="checkbox">
                  ...
                  <button type="submit" class="btn btn-info">Registar Pago</button>
              </form> 
            </div>
          </div>
        </div>
