  ...
  foreach ($products as $product) {
    ...
    // }
    $dep = ProductoData::deposito($cant->DEPOSITO_ID);
    // array_push($result, $product);
    array_push($result, array("cantidad" => $q, "deposito" => $dep[0]->NOMBRE_DEPOSITO, "deposito_id" => $cant->DEPOSITO_ID, "precio" => $precio, "tipo" => $tipo->TIPO_PRODUCTO, "producto" => $product));
  }
