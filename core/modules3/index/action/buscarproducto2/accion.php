    ...
    <?php if ($u->is_admin) : ?>
      <?php if (isset($_GET["producto"]) && $_GET["producto"] != "") : ?>
        ...
        ?>
              ...
              if ($q > 0) : ?>
                <tr class="<?php if ($q <= $product->minimo_inventario) {
                  ...
                  <td style="width:250px;">
                    <form method="post" action="index.php?action=agregarcantidad">
          ...
          <?php if ($sin_cantidad > 0) {
            echo "<p class='alert alert-warning'>Se omitieron <b>productos</b> que no tienen existencias en el inventario. <a href='index.php?module=inventary'>Ir al Inventario</a></p>";
          } ?>
              ...
              <tr class="<?php if ($q <= $product->minimo_inventario) {
                ...
                <?php if ($product->sucursal_id == $sucursales->id_sucursal) : ?>
                  ...
                  <td style="width:300px;">
                    <form method="post" action="index.php?action=agregarcantidad1">
