...
class VentaData
{
	...
	{
		$sql = "select * from " . self::$tablename . " where sucursal_id=$id_sucursal and accion_id=2 and ( tipo_venta=4) and estado =1 and fecha >= '2023-01-01'  order by id_venta desc";
		$query = Executor::doit($sql);
		return Model::many($query[0], new VentaData());
	}
