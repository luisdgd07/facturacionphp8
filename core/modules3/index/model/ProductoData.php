...
class ProductoData
{
	...
	public function registrar_contrato()
	{
		...
		$sql .= "VALUES ($this->sucursal_id, \"$this->imagen\", \"$this->codigo\", \"$this->nombre\".'ass',  \"$this->descripcion\", $this->cantidad_inicial,  \"$this->impuesto\", \"$this->usuario_id\", 1, NOW(), $this->ID_TIPO_PROD, $this->cliente_id, $this->precio,\"$this->contrato\", \"$this->cuota\", $this->precio)";
