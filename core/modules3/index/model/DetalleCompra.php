...
class DetalleCompra {
	...
	public function getCompras(){ return ComprasData::getById($this->compras_id); }
	public function getCompra(){ return CompraData::getById($this->compra_id); }
...
// partiendo de que ya tenemos creado un objecto AlumnTeamData previamente utilizamos el contexto
	...
	public static function getById($id_periodocarpeta){
		...
		return Model::one($query[0],new DetalleCompra());
	}
	...
	public static function getAll(){
		...
		$query = Executor::doit($sql);
		return Model::many($query[0],new DetalleCompra());
