<div class="content-wrapper">
    <section class="content-header">
      <h1> <i class="fa fa-cube"></i> 
        Corte de Caja #<?php echo $_GET["id_caja"]; ?>
      </h1>
    </section>
      ...
      <div class="box">
        <div class="box-header with-border">
          <div class="box-tools pull-left">
            <a href="index.php?view=caja" data-toggle="modal" class="btn btn-success btn-sm"><i class="fa fa-refresh"></i></a>
          </div>
        ...
        <div class="box-body">
          <div class="box-body">
          <?php
      $products = VentaData::mostrar_caja($_GET["id_caja"]);
      if(count($products)>0){
      $total_total = 0;
      ?>
      <br>
