    ...
    <script>
        <?php if (isset($_GET['sd'])) { ?>
            ...
            function exportar() {
                ...
                window.open(`pdfs/stock.php?sd=<?php echo $_GET['sd'] ?>&ed=<?php echo $_GET['ed'] ?>&id_sucursal=<?php echo $_GET['id_sucursal'] ?>&categoria=<?php echo $_GET['categoria'] ?>&producto=<?php echo $_GET['producto'] ?>`);
