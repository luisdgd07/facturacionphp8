  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1><i class='fa fa-steam-square' style="color: orange;"></i>
        Registro de monto de parametro de venta Masiva
             ...
             <?php
              ...
              <table id="example1" class="table table-bordered table-dark" style="width:100%">
                ...
                <tbody>
                  ...
                  echo "<p class='alert alert-danger'>No hay Configuracion registrada</p>";
                }
                ?>
                </tbody>
              </table>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title"><i class="fa fa-steam-square" style="color: orange;"></i><b style="color: black;"> Agregar Nueva Configuración</b></h4>
            </div>
            <div class="modal-body">
              <form class="form-horizontal" action="index.php?action=nuevocategoria" role="form" method="post" enctype="multipart/form-data">
                <div class="form-group has-feedback has-warning">
                    <label for="inputEmail1" class="col-sm-3 control-label">Cantidad</label>
                    <div class="col-sm-9">
...
<?php endif ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1><i class='fa fa-steam-square' style="color: orange;"></i>
        Registro de Parametro de monto tope de la venta masiva
       <!-- <marquee> Lista de Medicamentos</marquee> -->
      </h1>
    </section>
    <!-- Main content -->
        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body">
              <div class="table-responsive">
             <?php
                $categorias = ConfiguracionMasivaData::vercamasivasucursal($sucursales->id_sucursal);
                // $categorias = ConfiguracionMasivaData::vercamasivaactivosucursal($sucursales->id_sucursal);
                if(count($categorias)>0){
                  // si hay categorias
                  ?>
              <table id="example1" class="table table-bordered table-dark" style="width:100%">
                ...
                <tbody>
                  <?php
                    ...
                    ?>
                  <tr>
                  <td><?php if ($categoria->cantidad==10000000): ?>
                    <?php echo $categoria->cantidad; ?> ₲ 
                  <?php else: ?>
                    <?php echo $categoria->cantidad; ?> <i class="fa fa-dollar">
                  <?php endif ?> </i></td>
...
<div class="modal fade" id="addnew">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" action="index.php?action=nuevoconfiguracionmasiva1" role="form" method="post" enctype="multipart/form-data">
                <div class="form-group has-feedback has-warning">
                    <label for="inputEmail1" class="col-sm-3 control-label">Cantidad</label>
                    <div class="col-sm-9">
