 ...
 <?php
$cliente = CategoriaData::getById($_GET["id_categoria"]);
// $url = "storage/plato/".$cliente->id_plato."/".$cliente->imagen;
?>
 <div class="content-wrapper">
    <section class="content-header">
      <h1><i class='fa fa-steam' style="color: orange;"></i>
        ACTUALIZACIÓN DE LA CATEGORIA: <b style="color: orange;"><?php echo $cliente->nombre; ?></b>
      </h1>
    </section>
    <!-- Main content -->
            ...
            <div class="box-body">
              <div class="box box-warning">
                    <div class="panel-body">
                      <form class="form-horizontal" action="index.php?action=actualizarcategoria" role="form" method="post" enctype="multipart/form-data">
