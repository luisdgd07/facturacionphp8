  ...
  <section class="content">
    ...
    <script>
      function buscar() {
        ...
        $.ajax({
          url: `/index.php?action=clientecontrato&id=${$('#cliente_id').val()}&contrato=${$('#contratos').val()}`,
          method: 'GET',
          dataType: 'json',
          cache: false,
      ...
      function buscar2() {
        ...
        console.log();
        $.ajax({
          url: `/index.php?action=clientecontratoss&id=${$('#cliente_id').val()}&contrato=${$('#contratos').val()}`,
          method: 'GET',
          dataType: 'json',
          cache: false,
          success: function(data) {
