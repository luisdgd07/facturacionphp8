  ...
  ?>
                ...
                <div class="box-body">
                  ...
                  <div class="row ">
                    <div class="col-md-4 " style="margin-top: 15px;">
                      ...
                      <div class="col-lg-9">
                        <?php if (isset($_GET['tid'])) { ?>
                          <select name="cliente_id" onchange="clienteTipo(),vendedor()" class="selectpicker show-menu-arrow" data-style="form-control" data-live-search="true" id="cliente_id" class="form-control">
                    ...
                    <div class="col-md-4 " style="margin-top: 15px;">
                      ...
                      <div class="col-lg-9">
                        <?php if (isset($_GET['tid'])) { ?>
                          <select name="vendedor" onchange="" class="selectpicker show-menu-arrow" data-style="form-control" data-live-search="true" id="vendedor_id" class="form-control">
                            ...
                            foreach ($clients as $client) :
                              ...
                              if ($client->id == $venta->vendedor) { ?>
                                <option selected value="<?php echo $client->id; ?>"><?php echo $client->nombre . " - " . $client->cedula; ?></option>
                              <?php
                              } else {
                              ?>
                                <option value="<?php echo $client->id; ?>"><?php echo $client->nombre . " - " . $client->cedula; ?></option>
                            <?php }
                            endforeach;
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-lg-4">
                            <input type="date" name="fecha" class="form-control" value="<?php echo $u->fechaactualizacion; ?>" id="fecha" placeholder="Efectivo">
                          </div>
                        </div>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form class="form-horizontal" action="index.php?action=nuevoclienteventa" role="form" method="post" enctype="multipart/form-data">
      ...
      <script>
		...
		function buscarvendedor(cliente_id_v) {
          $.ajax({
            url: "index.php?action=buscaenvendedor",
            type: "GET",
            data: {
              dpt: cliente_id_v,
            },
            cache: false,
            success: function(dataResult) {
              console.log('saawasa', dataResult)
              vendedor = "";

              var result = JSON.parse(dataResult);
              //  vendedor = `<option selected value="${result[0].id_distrito}">${result[0].descripcion}</option>`;
              for (const [id, data_1] of Object.entries(result)) {
                vendedor += `<option selected value="${data_1.id}">${data_1.nombre}</option>`;
              }
  ...
  <script>
   ...
   function obtenerBoton(id) {
              ...
              // producto "]["
              // id_producto "]},'${data_1["
              // producto "]['codigo']}','${data_1["
              // producto "]['impuesto']}','${data_1["
              // precio "]}',' ${data_1["
              // producto "]['nombre']}','${data_1["
              // tipo "]}',1,${parseInt(data_1["
              // producto "]["
              // precio_compra "])},${parseInt(data_1["
              // cantidad "])},\'${data_1["
              // insumos "]})
              //   console.log(JSON.parse(data_1));

              let cadenaSinComillas = data.trim().slice(1, -1);
              const data_1 = JSON.parse(cadenaSinComillas);
              agregar(data_1.producto.id_producto, data_1.producto.codigo, data_1.producto.impuesto, data_1.producto.codigo, data_1.producto.impuesto, data_1.producto.precio, data_1.producto.nombre, data_1.producto.precio_compra, data_1.cantidad, data_1.insumos)
          }

          function agregar(id, codigo, impuesto, precio, producto, tipo, stock, precioc, currentStock, insumos) {
              ...
              } else if (currentStock < parseInt($('#a' + id).val())) {
