                    ...
                    <div class="form-group">
                                    ...
                                    $.ajax({
                                      ...
                                      success: function(json){
                                        ...
                                        for(let i=0;i<total_registros_tabla;i++){
                                          $("#precio_venta_"+(i+1)).val($("#precio_venta_hidden_"+(i+1)).val()/cambio);
                                          $("#precio_total_"+(i+1)).val($("#precio_total_hidden_"+(i+1)).val()/cambio);
                                          $("#iva_"+(i+1)).html($("#iva_hidden_"+(i+1)).val()/cambio);
                                          $("#gravada_"+(i+1)).html($("#gravada_hidden_"+(i+1)).val()/cambio);
                                        }
                                        
                                        if(Number(document.getElementById("tipomoneda_id").value) == 2){
                                          $("#cantidaconfigmasiva").val($("#cantidaconfigmasiva").val()/cambio_guaranie_global);
                                        }else{
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          ...
                          <div id="ocultar">
                            <div class="form-group">
                              <label for="inputEmail1" class="col-lg-3 control-label">Forma Pago</label>
                              <div class="col-lg-9">
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                              <label
                               for="inputEmail1" class="col-lg-2 control-label">Met. Pago</label>
                              <div class="col-lg-4">
                             ...
                             <div class="form-group">
                                <label for="inputEmail1" class="col-lg-2 control-label">FecVenta</label>
                                <div class="col-lg-4">
                            ...
                            <input type="hidden" id="iva_hidden_<?=$total_registros+1?>" value="                            <?php
                              ...
                              switch($product->impuesto){
                                ...
                                case 5:
                                  ...
                                  break;
                                default:
                                  $resultado_valor = round((($product->precio_venta*$p["q"])),2);
                              }
                              echo $resultado_valor; 
                            ?>">
                          </td>
  ...
  <!--*********** -->     <td>
                          ...
                          <td>
                            <input type="text" name="" id="precio_total_<?=$total_registros+1?>" value="<?php  $pt = $product->precio_venta*$p["q"]; $total1 +=$pt; echo $product->precio_venta*$p["q"]; ?>">
                            <input type="hidden" name="" id="precio_total_hidden_<?=$total_registros+1?>" value="<?php  $pt = $product->precio_venta*$p["q"]; echo $product->precio_venta*$p["q"]; ?>">
                          </td>
  ...
  ;
    ...
    $.ajax({  
      ...
      success: function(json){
        document.getElementById('cambio').value=json[0].valor;
        const cambio = json[0].valor;
        obtenerValorCambioGlobalGuaranie(json[0].valor);
        for(let i=0;i<total_registros_tabla;i++){
          $("#precio_venta_"+(i+1)).val($("#precio_venta_hidden_"+(i+1)).val()/cambio);
          $("#precio_total_"+(i+1)).val($("#precio_total_hidden_"+(i+1)).val()/cambio);
          $("#iva_"+(i+1)).html($("#iva_hidden_"+(i+1)).val()/cambio);
        ...
        $("#total5").val(format(total_gravada5/cambio));
        $("#exenta").val(format(total_exenta/cambio));
        const valortotal_final = format(total_ventas/cambio);
        $("#txtTotalVentas").val(valortotal_final);
    ...
    function obtenerValorCambioGlobalGuaranie(valor){
      cambio_guaranie_global = valor;
    }

    for(let i=0;i<total_registros_tabla;i++){
      $("#iva_"+(i+1)).html(format($("#iva_"+(i+1)).text().trim()));
      $("#gravada_"+(i+1)).html(format($("#gravada_"+(i+1)).text().trim()));
    }
  </script>