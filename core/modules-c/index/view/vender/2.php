                ...
                <?php if(isset($_SESSION["cart"])):
                  ...
                  <tr >
                    ...
                    <td><?php if ($product->impuesto==10): ?>
                      <b style="color: blue;"><?php echo (($product->precio_venta*$product->impuesto)/100);?></b>
                      <?php else: ?>
                      <?php if ($product->impuesto==5): ?>
                      <b style="color: green;"><?php echo (($product->precio_venta*$product->impuesto)/100);?></b>
                      <?php else: ?>
                      <b style="color: red;"><?php echo (($product->precio_venta*$product->impuesto)/100);?></b>
                    <?php endif ?>
                    <?php endif ?></td>
                    <!-- <td><?php echo (($product->precio_venta*$product->impuesto)/100); ?></td> -->
                    <td><b>Bs <?php echo number_format($product->precio_venta,0,'.','.'); ?></b></td>
                    <td><?php if ($product->impuesto==10): ?>
                      <b style="color: blue;">Bs  <?php echo $pt = ($product->precio_venta*$p["q"])-(($product->precio_venta*$product->impuesto)/100); $total10por +=($product->precio_venta*$p["q"])-(($product->precio_venta*$product->impuesto)/100); ?></b>
                      <?php else: ?>
                        <?php if ($product->impuesto==5): ?>
                      <b style="color: green;">Bs  <?php echo $pt = ($product->precio_venta*$p["q"])-(($product->precio_venta*$product->impuesto)/100); $total5por +=($product->precio_venta*$p["q"])-(($product->precio_venta*$product->impuesto)/100); ?></b>
                      <?php else: ?>
                        <b style="color: red;">Bs  <?php echo $pt = ($product->precio_venta*$p["q"])-(($product->precio_venta*$product->impuesto)/100); $total0porc +=($product->precio_venta*$p["q"])-(($product->precio_venta*$product->impuesto)/100); ?></b>
                    <?php endif ?>
                    <?php endif ?></td>
                    <td><b>Bs <?php  $pt = $product->precio_venta*$p["q"]; $total +=$pt; echo number_format($pt,0,'.','.'); ?></b></td>
                  ...
                  <form method="post" class="form-horizontal" id="processsell" action="index.php?action=procesoventaproducto1">
                    <div style="border-color: #FF0000;">
                      <div class="form-group">
                        <label for="inputEmail1" class="col-lg-2 control-label">Orden de Compra</label>
                        <div class="col-lg-2">
                          <input type="text" name="orden" class="form-control" required value="0" id="orden" placeholder="Descuento">
                        </div>
                          ...
                          $clients = ConfigFacturaData::verfacturasucursal($sucursales->id_sucursal);
                              ?>
                              <select required name="configfactura_id" class="form-control">
                              <?php foreach($clients as $client):?>
                                <option value="<?php echo $client->id_configfactura ;?>"><?php echo $client->comprobante1;?></option>
                              <?php endforeach;?>
                                </select>
                              </div>
                          ...
                          $monedas = MonedaData::versucursalmoneda($sucursales->id_sucursal);
                              ?>
                              <select required name="tipomoneda_id" id="valor" class="form-control" oninput="operacionmoneda()">
                              <!-- <option value="">-- NINGUNO --</option> -->
                              <?php foreach($monedas as $moneda):?>
                                <option value="<?php echo $moneda->valor;?>"><?php echo $moneda->nombre."-".$moneda->simbolo." ".$moneda->valor;?></option>
                              <?php endforeach;?>
                                </select>
                              </div>
                            </div>
...
<!--                               <style>
                          ...
                          <div class="form-group">
                              <label
                               for="inputEmail1" class="col-lg-2 control-label">Forma Pago</label>
                              <div class="col-lg-10">
                                <div class="multiselectt">
                                      ...
                                      <div id="checkboxess">
                                        <label for="Efectivo"> <a type="button" onclick="Mostrar();">Targeta</a></label>
                                        <label for="Debito"><a type="button" onclick="Ocultar();">Contado</a></label>
                                      </div>
                                    </div>
                                    <script>
                                      var expanded = false;
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-lg-10">
                                <select class="form-control">
                                  ...
                                  <option>Targeta de Debito</option>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-lg-10">
                                <input type="number"  name="codigo" class="form-control" required value="0" id="codigo" placeholder="Descuento">
                              </div>
                            </div>
                          <div class="form-group">
                              <label for="inputEmail1" class="col-lg-2 control-label">Descuento</label>
                              <div class="col-lg-10">
                                <input type="number"  name="descuento" class="form-control" required value="0" id="descuento" placeholder="Descuento">
                              </div>
                            </div>
                           <div class="form-group">
                              <label for="inputEmail1" class="col-lg-4 control-label">Monto a Pagar</label>
                              <div class="col-lg-4">
                                <input type="number"  name="money"  required class="form-control" id="money" placeholder="Efectivo" value="<?php echo $total; ?>" readonly="">
                              </div>
                              <div class="col-lg-4">
                                <input type="number" name="resultado1" required class="form-control" id="resultado1" placeholder="Efectivo">
                              </div>
                            </div>
                            </div>
                                <input type="hidden" name="total" value="<?php echo $total; ?>" class="form-control" placeholder="Total">
                          <div id="mostrar">
                           <div class="form-group">
                              ...
                              <div class="col-lg-9">
                                <input type="date" name="fechapago" required class="form-control" id="fechapago" placeholder="Efectivo" value="<?php echo $total; ?>">
                              </div>
                            </div>
                            <div class="form-group">
                              <label for="inputEmail1" class="col-lg-3 control-label">Monto A pagar</label>
                              <div class="col-lg-9">
                                <input type="text" name="fechapago" readonly="" class="form-control" id="fechapago" placeholder="Efectivo" value="<?php echo $total; ?>">
                              </div>
                            </div>
                          </div> 
                    </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-lg-8">
                                <div class="multiselect">
                                      ...
                                      <div id="checkboxes">
                                        <label for="Efectivo"> <a type="button" onclick="Mostrar();">Credito</a></label>
                                        <label for="Debito"><a type="button" onclick="Ocultar();">Contado</a></label>
                                      </div>
                                    </div>
                                    <script>
                  ...
                  <tr>
                    ...
                    <td><p><b> <?php echo number_format($total10por,0,'.','.'); ?> 
                    </b></p></td>
                    <td>IVA. 10%</td>
                    <td><p><b> <?php echo number_format((($total10por*10)/100),0,'.','.'); ?> 
                  </tr>
                  <tr>
                    <td><p>Grabada 5%</p></td>
                    <td><p><b> <?php echo number_format($total5por,0,'.','.'); ?></b></p></td>
                    <td>IVA. 5%</td>
                    <td><p><b> <?php echo number_format((($total5por*5)/100),0,'.','.'); ?> 
                  </tr>
                  <tr>
                    <td><p>Exenta</p></td>
                    <td><p><b> <?php echo number_format($total0porc,0,'.','.'); ?></b></p></td>
                  </tr>
                  <tr>
                    <td><p>Total</p></td>
                    <td><p><b> <?php echo number_format($total,0,'.','.'); ?></b></p></td>
