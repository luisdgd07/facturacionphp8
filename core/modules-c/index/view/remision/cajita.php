            ...
            <div class="col-xs-12">
              <div class="box">
                ...
                <div class="box-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        <div class="form-group">
                          <label for="inputEmail1" class="col-lg-2 control-label">Contrato:</label>
                          <div class="col-lg-8">
                ...
                <div class="">
                  ...
                  <h2 class="text-center" style="display: none;">Serie de las placas:</h2>
                  <label for="inputEmail1" style="display: none;" class="col-lg-2 control-label">N° Serie:</label>
                  <div class="col-lg-2 " style="display: none;">
                  ...
                  <label for="inputEmail1" class="col-lg-2 control-label" style="display: none;">Cantidad:</label>
                  <div class="col-lg-2" style="display: none;">
  ...
  <script>
          ...
          success: function(dataResult) {
            ...
            try {
              if (dataResult.includes("<")) {
                ...
                alert("Remision " + dataResult + " realizada ");
    ...
    function buscaContrato() {
      ...
      //  ciudades(595);
      $.ajax({
        url: "index.php?action=buscarcontrato",
        type: "GET",
        data: {
          id: $("#cliente_id").val(),
        },
        ...
        success: function(dataResult) {
          ...
          //  ciudades = `<option selected value="${result[0].id_distrito}">${result[0].descripcion}</option>`;
          for (const [id, data_1] of Object.entries(result)) {
            ciudades += `<option selected value="${data_1.id}">${data_1.descripcion} zona: ${data_1.zona}</option>`;
          }
          $("#contrato").html(ciudades);
        }
      });
    }
