            ...
            <div class="box-body">
              ...
              $totaliva0=0;
                ...
                <table id="example1" class="table table-bordered table-hover  ">
                  ...
                  <?php endif ?>>
                 <?php if ($sell->getVenta()->getCliente()->nombre=="X"&(($sell->getProducto()->precio_venta*$sell->q)*$sell->getVenta()->cambio)>$sell->getventa()->cantidaconfigmasiva): ?>
                    <td> <?php echo $sell->id_proceso; ?></td> 
                      <td><?php echo $sell->getProducto()->nombre ?></td>
                      <td><?php echo $sell->q ?></td>
                      <td><?php echo ($sell->getProducto()->precio_venta*$sell->q )*$sell->getVenta()->cambio?> <?php echo $sell->getVenta()->VerTipoModena()->simbolo ?></td>
                      ...
                      <?php else: ?>
                        <td width="140"><a href="" class="btn btn-info">Detalle</a> <!-- <a href="ticket2.php?id_venta=<?php echo $sell->getVenta()->id_venta;?>" class="btn btn-warning" target="_BLANCK">Factura</a> --> <a href="imprisionticketmasiva.php?id_venta=<?php echo $sell->getVenta()->id_venta;?>" class="btn btn-warning" target="_BLANCK">Factura</a>
                        </td>
                    <?php endif ?>
                    <?php endif ?>
