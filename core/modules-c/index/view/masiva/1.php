              ...
              $totaliva0=0;
                ...
                <table id="example1" class="table table-bordered table-hover  ">
                  ...
                  <?php endif ?>>
                    ...
                    <?php if (($sell->getProducto()->precio_venta*$sell->q)>2000&$sell->getVenta()->getCliente()->nombre=="X"): ?>
                      ...
                      <td><?php if ($sell->getProducto()->impuesto=="10"): ?>
                        <b style="color: blue;"><?php echo $sell->getProducto()->impuesto ?>% <?php  echo ((($sell->getProducto()->precio_venta*$sell->q)*$sell->getProducto()->impuesto)/100);$total10imp=((($sell->getProducto()->precio_venta*$sell->q)*$sell->getProducto()->impuesto)/100);?></b>
                      <?php else: ?>
                        <?php if ($sell->getProducto()->impuesto=="5"): ?>
                        <b style="color: green;"><?php echo $sell->getProducto()->impuesto ?>% <?php  echo ((($sell->getProducto()->precio_venta*$sell->q)*$sell->getProducto()->impuesto)/100);$total5imp=((($sell->getProducto()->precio_venta*$sell->q)*$sell->getProducto()->impuesto)/100);?></b>
                        <?php else: ?>
                        <?php if ($sell->getProducto()->impuesto=="0"): ?>
                        <b style="color: red;"><?php echo $sell->getProducto()->impuesto ?>% <?php  echo ((($sell->getProducto()->precio_venta*$sell->q)*$sell->getProducto()->impuesto)/100);$tota0imp=((($sell->getProducto()->precio_venta*$sell->q)*$sell->getProducto()->impuesto)/100);?></b>
                      <?php endif ?>
                      <?php endif ?>
                      <?php endif ?></td>
                      <td><?php if ($sell->getProducto()->impuesto=="10"): ?>
                        <b style="color: blue;"><?php  echo $total10imp?></b>
                      <?php else: ?>
                        <?php if ($sell->getProducto()->impuesto=="5"): ?>
                        <b style="color: blue;"><?php  echo $total5imp?></b>
                      <?php else: ?><?php if ($sell->getProducto()->impuesto=="0"): ?>
                        <b style="color: blue;"><?php  echo $tota0imp?></b>
                      <?php endif ?>
                      <?php endif ?>
                      <?php endif ?></td>
                      <td><?php if ($sell->getProducto()->impuesto=="10"): ?>
                        <b style="color: blue;"><?php  echo (($sell->getProducto()->precio_venta*$sell->q)-$total10imp);$totaliva10=(($sell->getProducto()->precio_venta*$sell->q)-$total10imp)?></b>
                      <?php else: ?>
                        <?php if ($sell->getProducto()->impuesto=="5"): ?>
                        <b style="color: blue;"><?php  echo (($sell->getProducto()->precio_venta*$sell->q)-$total5imp);$totaliva5=(($sell->getProducto()->precio_venta*$sell->q)-$total5imp)?></b>
                      <?php else: ?>
                        <?php if ($sell->getProducto()->impuesto=="0"): ?>
                        <b style="color: blue;"><?php  echo (($sell->getProducto()->precio_venta*$sell->q)-$tota0imp);$totaliva0=(($sell->getProducto()->precio_venta*$sell->q)-$tota0imp)?></b>
                      <?php endif ?>
                      <?php endif ?>
                      <?php endif ?></td>
                                        ...
                                        <div class="form-group has-feedback has-error">
                                         ...
                                         <input type="hidden" name="sucursal_id" value="<?php echo $sucursales->id_sucursal; ?>">
                                          ...
                                          <?php if ($sell->getProducto()->impuesto=="10"): ?>
                                            <input type="hidden"  class="form-control" name="iva10" value="<?php  echo $total10imp?>">
                                            <input type="hidden"  class="form-control" name="total10" value="<?php  echo $totaliva10?>">
                                            <?php else: ?>
                                            <?php if ($sell->getProducto()->impuesto=="5"): ?>
                                            <input type="hidden" class="form-control" name="iva5" value="<?php  echo $total5imp?>">
                                            <input type="hidden" class="form-control" name="total5" value="<?php  echo $totaliva5?>">
                                            <?php else: ?> 
                                              <?php if ($sell->getProducto()->impuesto=="0"): ?>
                                            <input type="hidden" class="form-control"  name="iva0" value="<?php  echo $tota0imp?>">
                                            <input type="hidden" class="form-control"  name="exenta" value="<?php  echo $totaliva0?>">
                                          <?php endif ?>
                                          <?php endif ?>                           
                                          <?php endif ?>
