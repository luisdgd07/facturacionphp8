                                                                                            ...
                                                                                            punto: <?php echo substr($sell->factura, 4, -8) ?>,
                                                                                              transporte : {
                                                                                                ...
                                                                                                entrega : {
                                                                                                    ...
                                                                                                    departamento : <?php echo $dptClient ?>,
                                                                                                    departamentoDescripcion : "",
                                                                                                    distrito :<?php echo $distClient ?>,
                                                                                                    distritoDescripcion : "",
                                                                                                    ciudad : <?php echo $ciudadCliente ?>,
                                                                                                    ciudadDescripcion : "",
                                                                                                    pais : "PRY",
                                                                                                    paisDescripcion : "Paraguay",
                                                                                                    telefonoContacto : ""
                                                                                                ...
                                                                                                transportista : {
                                                                                                    contribuyente : true,
                                                                                                    nombre : "<?php echo $sucursalDatos->razon_social ?>",
                                                            ...
                                                            <td>
                                                                ...
                                                                ?>
                                                                    ...
                                                                    <?php if ($sucursalDatos->tipo_recibo == 0) { ?>
                                                                        ...
                                                                        <button class="btn btn-success" onclick='kudedescargar(<?php echo json_encode($productosItem) ?>,"<?php echo $venta->cdc ?>","<?php echo $venta->factura ?>","<?php echo $venta->fecha_envio ?>","<?php echo $venta->metodopago ?>","<?php echo $rucCLiente  ?>",<?php echo $cambio;  ?>,"<?php echo $cliente ?>","<?php echo $moneda; ?>","<?php echo $direccionCliente; ?>","<?php echo $telefono; ?>",<?php echo $venta->iva10; ?>,<?php echo $venta->iva5; ?>,0,"<?php echo $client->email; ?>","<?php echo $venta->tipo_remision; ?>","<?php echo $u->nombre . " " . $u->apellido ?>","<?php echo $vehiculo->marca ?>","<?php echo $vehiculo->chapa_nro ?>","<?php echo $chofer->nombre ?>","<?php echo $chofer->direccion ?>","<?php echo $chofer->cedula ?>")'>Descargar</button>
...
<script>
    ...
    function kude(items, cdc, factura, fecha, condicion, rucCliente, cambio, cliente, moneda, direccion, telefono, iva10, iva5, tipo, email, tiporemi, usuario, marca, chapa, chofer, dircho, cicho) {
        console.log(items)
        Swal.fire({
        ...
        $.ajax({
            ...
            data: {
                ...
                operacion: 'Remisión Electronica',
                telCliente: telefono,
                docAsociado: '',
                cel: '',
                iva10,
    ...
    function kudedescargar(items, cdc, factura, fecha, condicion, rucCliente, cambio, cliente, moneda, direccion, telefono, iva10, iva5, tipo, email) {
        console.log(items)
        Swal.fire({
