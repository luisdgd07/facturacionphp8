        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body">
              <div class="table-responsive">
             <?php
                $configfacturas = ChoferData::listar($sucursales->id_sucursal);
              ...
              <table id="example1" class="table table-bordered table-dark" style="width:100%">
                ...
                <tbody>
                  <?php
                    ...
                    ?>
                  <tr>
                  <td><?php echo $configfactura->id_chofer; ?></td>
                  ...
                  <?php endif ?></td>
                  <td style="width:150px;">
                    <a href="index.php?view=actualizarchofer&id_sucursal=<?php echo $sucursales->id_sucursal;?>&id_chofer=<?php echo $configfactura->id_chofer;?>" data-toggle="modal" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-cog"></i> Editar</a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
              <h4 class="modal-title"><i class="fa fa-steam-square" style="color: orange;"></i><b style="color: black;"> Agregar nuevo Chofer</b></h4>
            </div>
            <div class="modal-body">
              <form class="form-horizontal" action="index.php?action=nuevo_chofer" role="form" method="post" enctype="multipart/form-data">
               
                <div class="form-group has-warning">
                    <label for="inputEmail1" class="col-sm-3 control-label">Nombre Chofer:</label>
                    <div class="col-sm-9">
				 ...
				 <div class="form-group has-warning">
                    <label for="inputEmail1" class="col-sm-3 control-label">Cedula:</label>
                    <div class="col-sm-9">
