 ...
 <?php
$cliente = ChoferData::VerId($_GET["id_chofer"]);
 ...
 <div class="content-wrapper">
    <section class="content-header">
      <h1><i class='fa fa-steam' style="color: orange;"></i>
        ACTUALIZACIÓN DE REGISTRO DE CHOFER: <b style="color: orange;"><?php echo $cliente->nombre; ?></b>
      </h1>
    </section>
    <!-- Main content -->
        ...
        <div class="col-md-12">
            ...
            <div class="box-body">
              <div class="box box-warning">
                    <div class="panel-body">
                      <form class="form-horizontal" action="index.php?action=actualizarchofer" role="form" method="post" enctype="multipart/form-data">
          ...
          <div class="col-sm-9">
            ...
            <div class="modal-footer">
              ...
              <input type="hidden" name="id_chofer" value="<?php echo $cliente->id_chofer; ?>">
