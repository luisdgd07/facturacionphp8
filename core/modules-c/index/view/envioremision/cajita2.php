                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                ?>
                                                                    ...
                                                                    <?php if ($sucursalDatos->tipo_recibo == 0) { ?> <a class="btn btn-primary" href="./impresionkuderemision2.php?id_venta=<?php echo $sell->id_venta; ?>">Descargar Kude</a>
                                                                    <?php }
                                                                    if ($sucursalDatos->tipo_recibo == 1) { ?>
                                                                        <a class="btn btn-primary" href="./impresionkuderemision.php?id_venta=<?php echo $sell->id_venta; ?>">Descargar Kude</a>
