                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <?php if ($sell->enviado == "Rechazado") { ?>
                                                                    <a class="btn btn-primary" href="http://localhost:3.000/downloadxml/<?php echo $sell->xml; ?>">Descargar XMl</a>
                                                            ...
                                                            <td>
                                                                ...
                                                                <?php } else if ($sell->enviado == "Aprobado") {
                                                                    ...
                                                                    $productosItem  = array();
                                                                    // var_dump($operations);
                                                                    $tipoi = ProductoData::verinsumo($operations[0]->sucursal_id);
                                                                    $insumo = $tipoi->ID_TIPO_PROD;
                                                                    foreach ($operations as $operation) {
                                                                        $product  = $operation->getProducto();
                                                                        if ($product->ID_TIPO_PROD == $insumo) {
                                                                        } else {
                                                            ...
                                                            <td>
                                                                ...
                                                                ?>
                                                                    ...
                                                                    <?php if ($sucursalDatos->tipo_recibo == 0) { ?>
                                                                        ...
                                                                        <button class="btn btn-success" onclick='kudedescargar(<?php echo json_encode($productosItem) ?>,"<?php echo $venta->cdc ?>","<?php echo $venta->factura ?>","<?php echo $venta->fecha_envio ?>","<?php echo $venta->metodopago ?>","<?php echo $rucCLiente  ?>",<?php echo $cambio;  ?>,"<?php echo $cliente ?>","<?php echo $moneda; ?>","<?php echo $direccionCliente; ?>","<?php echo $telefono; ?>",<?php echo $venta->iva10; ?>,<?php echo $venta->iva5; ?>,0,"<?php echo $client->email; ?>","<?php echo $venta->tipo_remision; ?>","<?php echo $u->nombre . " " . $u->apellido ?>","<?php echo $vehiculo->marca ?>","<?php echo $vehiculo->chapa_nro ?>","<?php echo $chofer->nombre ?>","<?php echo $chofer->direccion ?>","<?php echo $chofer->cedula ?>",<?php echo json_encode($p) ?>,<?php echo $venta->tipo_remision ?>)'>Descargar</button>
...
<script>
    ...
    function kudedescargar(items, cdc, factura, fecha, condicion, rucCliente, cambio, cliente, moneda, direccion, telefono, iva10, iva5, tipo, email, tiporemi, usuario, marca, chapa, chofer, dircho, cicho, placas, motivo) {
