                        ...
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="col-md-2" style="margin-top: 20px;">
                                    <input type="number" onchange="tipocambio()" name="cambio2" id="cambio2" value="<?php echo $valores; ?>" class="form-control">
                        ...
                        success: function(json) {
                            if (json.simbolo.includes("US$")) {
                                ...
                                if ($('select[name="tipomoneda_id"] option:selected').text().includes("US$")) {
                                    ...
                                    $("#monto").val(parseFloat(totalCobro));
                                }
                            }
                            console.log(json)
