...
<div class="content-wrapper">
    ...
    <section class="content">
      <div class="box">
        ...
        <div class="box-body">
          <form>
            <input type="hidden" name="view" value="reporteproducto">
            <div class="row">
            <div class="col-md-3">
...
<?php if($_GET["sd"]!=""&&$_GET["ed"]!=""):?>
      ...
      if($_GET["uso_id"]==""){
      $operations = ProductoData::getAllByDateOfficial($_GET["sd"],$_GET["ed"],2);
      }
      else{
      $operations = ProductoData::getAllByDateBCOpp($_GET["uso_id"],$_GET["sd"],$_GET["ed"],2);
      } 
...
<?php foreach($operations as $operation):?>
  <tr>
    <td>Bs <?php echo ($operation->nombre); ?></td>
    <td>Bs <?php echo ($operation->codigo); ?></td>
    <td>Bs <?php echo ($operation->serie); ?></td>
    <td><?php echo $operation->estado; ?></td>
     <td style="width:90px;"><center><?php if($operation->activo):?><i style="color: blue;" class="fa fa-check"></i><?php else: ?><i style="color: red;" class="fa fa-remove"></i><?php endif; ?></center> </td>
