              ...
              <?php if (count($sucursales) > 0) : ?>
                <?php foreach ($sucursales as $sucur) :
                  ...
                  <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="treeview">
                      <a href="#">
                        <i class="fa fa-user-secret" style="color: yellow;"></i> <span>TERCEROS</span>
                        <span class="pull-right-container">
                          <i class="fa fa-angle-left pull-right"></i>
                        </span>
                      </a>
                      <ul class="treeview-menu">
                        <!-- <li><a href="index.php?view=empleado"><i class="fa fa-user"></i> Empleados</a></li> -->
                        ...
                        <!-- <li><a href="index.php?view=administrador&id_sucursal=<?php echo $sucursal->id_sucursal; ?>"><i class="fa fa-user-secret" style="color: orange;"></i> Administradores</a></li> -->
                      </ul>
                    </li>
                    <li class="treeview">
                      <a href="#">
                    ...
                    <li class="treeview">
                      ...
                      <ul class="treeview-menu">
                        ...
                        <li><a href="index.php?view=cobranza&id_sucursal=<?php echo $sucursal->id_sucursal; ?>"><i class="fa fa-cart-plus" style="color: orange;"></i>Ventas a creditos</a></li>
                    ...
                    <li class="treeview">
                      ...
                      <ul class="treeview-menu">
                         <li><a href="index.php?view=cobranza1&id_sucursal=<?php echo $sucursal->id_sucursal; ?>"><i class="fa fa-money" style="color: orange;"></i> Realizar Cobranza</a></li>
						  <li><a href="index.php?view=cobros_realizados&id_sucursal=<?php echo $sucursal->id_sucursal; ?>"><i class="fa fa-cart-plus" style="color: orange;"></i>Cobranzas</a></li>
                        <li><a href="index.php?view=estadodecuenta&id_sucursal=<?php echo $sucursal->id_sucursal; ?>"><i class="fa fa-money" style="color: orange;"></i>Estado de cuentas</a></li>
                  ...
                  <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                      ...
                      <li><a href="index.php?view=libroventa&id_sucursal=<?php echo $sucursal->id_sucursal; ?>"><i class="fa fa-bar-chart-o" style="color: orange;"></i> Reporte Libro Ventas</a></li>
                      ...
                      <li><a href="index.php?view=reporteventa&id_sucursal=<?php echo $sucursal->id_sucursal; ?>"><i class="fa fa-bar-chart-o" style="color: orange;"></i> Reporte Ventas</a></li>
