...
?>
    <?php if ($u->is_empleado) : ?>
        ...
        <script>
            function imprimir() {
                window.open('impresionestado.php?cliente_id=<?= $_GET['cliente_id'] ?>&sd=<?= $_GET['sd'] ?>&ed=<?= $_GET['ed'] ?>&id_sucursal=<?= $_GET['id_sucursal'] ?>')
            }

            function excel() {
                window.open('csvestadocuentas.php?cliente_id=<?= $_GET['cliente_id'] ?>&sd=<?= $_GET['sd'] ?>&ed=<?= $_GET['ed'] ?>&id_sucursal=<?= $_GET['id_sucursal'] ?>')
            }
        </script>
        </div>
