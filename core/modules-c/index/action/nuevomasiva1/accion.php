<?php
 ...
 //  $cant_productos_x_factura=rand(1,$cant_productos_x_factura_fin);
  ...
  // if(($cantidad_porfact <= $cantidad_venta )) {
	...
	$i=1;
    //$cant_productos_x_factura=(rand(1,$cant_productos_x_factura_fin)+2);
	
	 
	while ($cantidad_porfact <= $cantidad_venta)
    ...
    $cantidad_total_registrada =  $cantidad_porfact - $cant_productos_x_factura+1;
	
	

    $cantidad_restante_productos = $cantidad_venta - $cantidad_total_registrada;
	
	if (($cantidad_restante_productos <= 0 ) )  {
