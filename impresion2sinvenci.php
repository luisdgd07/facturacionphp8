...
<body id="cuerpoPagina">
    ...
    <div class="zona_impresion" style="margin-top: 125px;">
        <table border="0" align="center" width="915px" style="font-size:15pt;">
            ...
            <div style="font-size:11pt; margin-left:198px">
                <?php if ($ventas->metodopago == "Contado") { ?>
                    <div class="" style="margin-top:0px; margin-left:650px">
                        x
                    </div>
                ...
                <?php } else { ?>
                    ...
                    <div class="" style="margin-top: 10px; margin-left:741px">
                        x
                    </div>
                <?php } ?>

                <p style="font-size:11pt;margin-top: -5px; padding-bottom: 10px;margin-left:24px">
                    <?php
                    $fecha = $ventas->fecha_envio;
                ...
                <p style="font-size:10pt; white-space: nowrap;padding-bottom: 0px;margin-left:66px">
                    <?php echo $ventas->getCliente()->nombre . ' ' . $ventas->getCliente()->apellido ?>

                </p>

                <p style="font-size:11pt; padding-bottom: 0px; margin-left:86px;white-space: nowrap;">
                    <?= $ventas->getCliente()->dni ?>

                </p>

                <p style="font-size:10pt; white-space: nowrap;padding-bottom: 2px;margin-top: 5px; margin-left:25px">
        ...
        <table border="0" align="center" width="912px" style="font-size:15pt;margin-top: -1px; margin-left:63px">
            <thead>
                <tr>
        ...
        <table border="0" align="center" width="865px" style="font-size:15pt; margin-top: 320px; margin-left:165px">
            <thead>
                <tr>
                ...
                <tr>
                    ...
                    <td align="start">
                        <div style="text-transform:uppercase"> <?= $cifra->convertirNumeroEnLetras($total) ?>
                            <?php if ($ventas->VerTipoModena()->simbolo == "₲") {
        ...
        <table border="0" align="center" width="875px" style="font-size:15pt; margin-top: -47px; margin-left:65px">
            <thead>
                <tr>
                    <td style="font-size: 14px; font-family:  Arial, Helvetica, sans-serif;" class="text-center">
                    </td>
                    ...
                    <td></td>
                    <td align="start" style=" font-size: 14px; font-family:  Arial, Helvetica, sans-serif;">
        ...
        <table style="margin-left: 300px;margin-top:15px">
