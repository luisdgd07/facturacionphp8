    ...
    <div class="zona_impresion" style="margin-top: 125px;">
        <table border="0" align="center" width="915px" style="font-size:15pt;">
            ...
            <div style="font-size:11pt; margin-left:198px">
                ...
                <b><p style="font-size:10pt; margin-top: -7px; white-space: nowrap;padding-bottom: 0px;margin-left:60px">
                ...
                <b><p style="font-size:11pt; padding-bottom: 0px; margin-left:86px;white-space: nowrap; margin-top: -2px">
                    <?= $ventas->getCliente()->dni ?>

                </p></b>

               <b> <p style="font-size:10pt; white-space: nowrap;padding-bottom: 2px;margin-top: 10px; margin-left:25px">
                    <?=
        ...
        <table border="0" align="center" width="865px" style="font-size:15pt; margin-top: <?php echo (337 - ($lines * 20.5) - ($lines2 * 15)); ?>px; margin-left:190px">
            <thead>
                <tr>
                ...
                <tr>
                    ...
                    <td align="start">
                        <div style="text-transform:uppercase;white-space: nowrap"> <?php if ($ventas->VerTipoModena()->simbolo == "₲") {
                                                                                        ...
                                                                                        echo " ";
                                                                                    } ?><?= $cifra->convertirNumeroEnLetras($total);echo " ";echo "-"; ?>
                        </div>
                    </td>
