...
<body id="cuerpoPagina">
    ...
    <div class="zona_impresion">
        ...
        <thead>
		   ...
		   <tr>
            ...
            <tr>
             <td style="padding-left: 50px;padding-top: 15px; font-size: 15px; font-family:  Arial, Helvetica, sans-serif;" class="text-center">Cliente: <?php if ($ventas->getCliente()->tipo_doc=="SIN NOMBRE") {echo  $ventas->getCliente()->tipo_doc;
			 
			 }else {echo  $ventas->getCliente()->nombre." ".$ventas->getCliente()->apellido; }?>
    ...
    <table border="0" align="center" width="315px" style="font-size:15pt;color:black;">
        <thead>
            ...
            <tr>
                <p><td style="width:10%; font-size: 14px; font-family:  Arial, Helvetica, sans-serif;" align="center"><?= $ventas->cantidad?>&nbsp;&nbsp;</td></p>
                 <p><td style="width:50%; font-size: 14px; font-family:  Arial, Helvetica, sans-serif;"><?= $ventas->getProducto()->nombre;?>&nbsp;&nbsp;</td></p>
                 <p><td align="right" style="width:10%; font-size: 14px;font-family:  Arial, Helvetica, sans-serif;"><?= number_format(($ventas->total/$ventas->cantidad), 2, ',', '.')?>&nbsp;&nbsp;</td></p>
                 <p><td align="right" style="width:30%; font-size: 14px;font-family:  Arial, Helvetica, sans-serif;"><?php if ($ventas->VerTipoModena()->estado==1){ ?><?= number_format((($ventas->total)*$ventas->VerTipoModena()->valor), 2, ',', '.');$total+=(($ventas->total)*1)?><?php }else { if ($ventas->VerTipoModena()->simbolo=="US$") { ?> <?= number_format((($ventas->total)/1), 2, ',', '.');$total+=(($ventas->total)/1)?><?php }else { if ($ventas->VerTipoModena()->simbolo=="₲"){ ?><?= number_format((($ventas->total)*$ventas->VerTipoModena()->valor), 2, ',', '.');$total+=(($ventas->total)*$ventas->VerTipoModena()->valor)?><?php } } } ?>&nbsp;&nbsp;</td></p>
            </tr>
    ...
    <table border="0" align="center" width="315px" style="font-size:15pt;color:black;">
        <thead>
            <tr>
                ...
                <td style="padding-left: 50px;padding-top: 16px; font-size: 17px; font-family:  Arial, Helvetica, sans-serif;" class="text-center"><strong><font size="3"><?= number_format($total, 2, ',', '.')?></font></strong></td>
            </tr>
            <tr>
